...
public class LadyCharm_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Lady_Charm_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_scatter_free_spin_wild_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Lady_Charm_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/Lady_Charm/fwd_navigation.PNG");
		Pattern backward=new Pattern("./Images/Lady_Charm/bckwrd_navigation.PNG");
		Pattern exit=new Pattern("./Images/Lady_Charm/exit.PNG");
		Pattern payout=new Pattern("./Images/Lady_Charm/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/Lady_Charm/paylines_info.PNG");
		Pattern wild=new Pattern("./Images/Lady_Charm/wild_info.PNG");
		Pattern FreeSpin=new Pattern("./Images/Lady_Charm/FreeSpin_info.PNG");
		Pattern scatter=new Pattern("./Images/Lady_Charm/scatter_info.PNG");
		Pattern gamble=new Pattern("./Images/Lady_Charm/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/Lady_Charm/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/Lady_Charm/game_window.PNG");
...
//		click on backward icon available on the info page to move to wild window
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Lady_Charm_slot_game() throws Throwable {
