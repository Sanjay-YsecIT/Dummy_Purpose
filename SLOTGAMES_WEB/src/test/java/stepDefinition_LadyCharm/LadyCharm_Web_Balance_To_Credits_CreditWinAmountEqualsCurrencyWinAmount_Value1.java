...
public class LadyCharm_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value1 {
	...
	public void chrome_browser_valid_URL_valid_login_details_Lady_Charm_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits() throws Throwable {
	...
	public void open_the_Lady_Charm_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Lady_Charm_slot_game_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern balance=new Pattern("./Images/Lady_Charm/Reminingbal_299.80.PNG");
	

		// credit values
		Pattern win_cr = new Pattern("./Images/Lady_Charm/cr_winamt1.PNG");
		Pattern balance_cr=new Pattern("./Images/Lady_Charm/cr_bal1.PNG");
	...
	public void win_amount_in_credit_multiplied_by_denomination_is_equal_to_win_amount_in_currency_in_Lady_Charm_slot_game() throws Throwable {
