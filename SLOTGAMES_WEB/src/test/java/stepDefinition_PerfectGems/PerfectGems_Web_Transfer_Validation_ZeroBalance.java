...
public class PerfectGems_Web_Transfer_Validation_ZeroBalance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_zero_balance_text_field_to_transfer_balance_Ok_button_and_validation_message() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_as_zero_SRD_and_click_on_Ok_button() throws Throwable {
		...
		Pattern credit1=new Pattern("Images/Perfect_Gems/t_zerobalance.PNG");
	...
	public void an_error_should_be_displayed_if_balance_entered_was_zero_and_player_should_be_blocked_from_loading_the_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
