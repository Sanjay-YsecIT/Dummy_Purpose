...
public class PerfectGems_Web_Gamble_HomeButtons_Behaviour {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Perfect Gems slot game, spin, gamble link, gamble page, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_spin_gamble_link_gamble_page_HUD_buttons() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_spin_the_reels_and_access_to_gamble_and_click_on_HUD_buttons_present_on_the_screen() throws Throwable {
		...
		Pattern disable_credit=new Pattern("Images/Perfect_Gems/disable_credit1.PNG");
		Pattern disable_betvalue=new Pattern("Images/Perfect_Gems/disable_betvalue.PNG");
		...
		Pattern disable_hidden=new Pattern("Images/Perfect_Gems/hidden_disable.PNG");
		Pattern Afterspin_bal=new Pattern("Images/Perfect_Gems/balance1_1.PNG");
		...
		//Comparing the Bet value after clicking on disabled Bet value button and it should be 0.25
		...
		if(finder5.hasNext())
		{
			...
			System.out.println("After clicking on Bet button, bet value selected is 0.25. Test case4 passed");
			finder5.destroy();  
		}         
		else    
		{ 
	...
	public void all_HUD_buttons_should_be_inactive_upon_click_shoudn_t_perform_any_action_in_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
