...
public class PerfectGems_Web_AutoSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern autoicon=new Pattern("Images/Perfect_Gems/autoplay.PNG");
		Pattern spin=new Pattern("Images/Perfect_Gems/spin.PNG");
		Pattern auto_stop=new Pattern("Images/Perfect_Gems/auto_stop.PNG");
		Pattern auto_auto=new Pattern("Images/Perfect_Gems/auto_auto.PNG");
		Pattern auto_home=new Pattern("Images/Perfect_Gems/disable_home.PNG");
		Pattern auto_info=new Pattern("Images/Perfect_Gems/disable_info.PNG");
		Pattern auto_lines=new Pattern("Images/Perfect_Gems/disable_lines.PNG");
		Pattern auto_turbo=new Pattern("Images/Perfect_Gems/disable_turbo.PNG");
		Pattern auto_credit=new Pattern("Images/Perfect_Gems/disable_credit1.PNG");
		Pattern auto_betvalue=new Pattern("Images/Perfect_Gems/disable_betvalue.PNG");
		Pattern betdropdown=new Pattern("Images/Perfect_Gems/bet_dropdown1.PNG");
		Pattern auto_betvalue_click=new Pattern("Images/Perfect_Gems/disable_betvalue_click.PNG");
		Pattern auto_credit_click=new Pattern("Images/Perfect_Gems/disable_credit_click.PNG");
		Pattern bet=new Pattern("Images/Perfect_Gems/bet1.PNG");
		Pattern payout1_1=new Pattern("Images/Perfect_Gems/payout1_1.PNG");
		Pattern placebet=new Pattern("Images/Perfect_Gems/placebet.PNG");
		Pattern credit1=new Pattern("Images/Perfect_Gems/cr1.PNG");
		Pattern astop=new Pattern("Images/Perfect_Gems/spin_stop.PNG");
		...
		screen.click(auto_credit);
		Thread.sleep(1000);
		Finder finder2 =new Finder(screen.capture().getImage());
		String ht2 = finder2.find(credit1);
		double score2=20;                
		...
		//Comparing the credit value after clicking on disabled credit value button and it should be 0.01
		Finder finder3 =new Finder(screen.capture().getImage());
		String ht3 = finder3.find(auto_credit);
		double score3=20;                
		...
		screen.click(auto_betvalue);
		Thread.sleep(1000);

		Finder finder4 =new Finder(screen.capture().getImage());
		String ht4 = finder4.find(betdropdown);
		double score4=20;                
		...
		//Comparing the Bet value after clicking on disbled Bet value button and it should be 0.25
		screen.wait(bet, 20);
		...
		if(finder5.hasNext())
		{
			...
			System.out.println("After clicking on Bet button, credit value selected is 0.25. Test case4 passed");
			finder5.destroy();  
		}         
		else    
		{ 
		...
		if(finder7.hasNext())
		{
			...
			System.out.println("Testcase7:Payout screen for betvalue 0.25 is not visible after clicking on info button . Test case passed");
			finder7.destroy();  
		}         
		else    
		{ 
		...
		//Comparing the paylines button on disabled button and it should be 243
		...
		if(finder31.hasNext())
		{
			...
			System.out.println("After clicking on paylines button paylines is 81. Test case3 passed");
			finder31.destroy();  
		}         
		else    
		{ 
		...
		String ht9 = finder9.find(url);
		double score9=20;                
		System.out.println("the value of ht9"+" "+ht9);
		if(finder9.hasNext())
		{
		...
		//To accept if the win triggered at the spin stop condition
		if  (screen.exists(take) != null)
		{
			screen.click(take);
			Thread.sleep(4000);
			System.out.println("win triggered at the autospin stop condition");
		}else
		{
			System.out.println("win is not triggered at the autospin stop condition");
		}
		...
		Finder finder39 =new Finder(screen.capture().getImage());
		String ht39 = finder39.find(placebet);
		double score39=20;                
		System.out.println("the value of ht39"+" "+ht39);
		if(finder39.hasNext())
		{
			Match m39=finder39.next();
			System.out.println("Match Found with: "+(m39.getScore())*100+"%");
			score39=(m39.getScore())*100;
		...
		System.out.println("Test case 9 comparision value equals to: "+" "+score39 +"%");
		Assert.assertTrue(score39 > 97);
	}
