...
public class PerfectGems_Web_HUD_Buttons_Validation {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Perfect Gems slot game, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_HUD_buttons() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_launch_the_game() throws Throwable {
		...
		Pattern HUD=new Pattern("Images/Perfect_Gems/HUD.PNG");
		Pattern spin=new Pattern("Images/Perfect_Gems/spin.PNG");
		Pattern spin_stop=new Pattern("Images/Perfect_Gems/spin_stop.PNG");
		Pattern turboON=new Pattern("Images/Perfect_Gems/turboON.PNG");
		Pattern turboOFF=new Pattern("Images/Perfect_Gems/turboOFF.PNG");
		Pattern hide=new Pattern("Images/Perfect_Gems/hide.PNG");
		Pattern unhide=new Pattern("Images/Perfect_Gems/unhide.PNG");
		Pattern balance_unhide=new Pattern("Images/Perfect_Gems/balance_unhide.PNG");
