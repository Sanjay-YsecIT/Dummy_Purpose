...
public class PerfectGems_Web_Gamble_WinAmount_AddedTo_Balance_InCredits {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_credit_balance_spin_button_credit_win_amount_gamble_button_gamble_amount_in_credits_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_in_credits_after_win() throws Throwable {
		...
		Pattern win_credits_1 = new Pattern("Images/Perfect_Gems/win_credits_1.PNG");
		Pattern balance=new Pattern("Images/Perfect_Gems/balance.PNG");
		Pattern balance_credits_1=new Pattern("Images/Perfect_Gems/balance_credits_1.PNG");
		Pattern credit_deductbal=new Pattern("Images/Perfect_Gems/balance_crdeduct_1.PNG");
		...
		Pattern Crpre_gambleamount=new Pattern("Images/Perfect_Gems/Crpre_gambleamount.PNG");
		Pattern Crpost_gambleamount=new Pattern("Images/Perfect_Gems/Crpost_gambleamount.PNG");
		Pattern Crpre_gambletowin=new Pattern("Images/Perfect_Gems/Crpre_gambletowin.PNG");
		Pattern credit_gamble_winbalance=new Pattern("Images/Perfect_Gems/credit_gamble_winbalance.PNG");
		Pattern credit_gamble_winfield=new Pattern("Images/Perfect_Gems/credit_gamble_winfield.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 80 and gamble amount is 40 after 1st win gamble amount is "80"
		...
		else
		{
			...
			if(finder11.hasNext())
			{
				...
				System.out.println("Balance After losing in gamble. Balance is 14,975");
				finder11.destroy();  
			}         
			else    
			{ 
	...
	public void verify_the_credit_form_of_currency_in_gamble_page_on_all_fields_in_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void gamble_credit_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
