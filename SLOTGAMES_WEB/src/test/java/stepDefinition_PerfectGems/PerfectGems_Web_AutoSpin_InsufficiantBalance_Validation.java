...
public class PerfectGems_Web_AutoSpin_InsufficiantBalance_Validation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_balance_AutoSpin_button_validation_message_maxbet_button_credit_decrement_button() throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_maxbet_click_on_Autospin_button_till_balance_turns_to_zero_and_check_the_validation_message_and_decrement_the_denomination_and_again_spin_the_reels() throws Throwable {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement TransferInput =	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("transferInput")));
		TransferInput.clear();
		Thread.sleep(1000);
		TransferInput.sendKeys("50");
		Thread.sleep(2000);
		...
		Pattern disable_spin=new Pattern("Images/Perfect_Gems/disable_spin.PNG");
		Pattern disable_bet4_5=new Pattern("Images/Perfect_Gems/disable_bet4_5.PNG");
		Pattern disable_betval=new Pattern("Images/Perfect_Gems/bet_dropdown4.PNG");
		Pattern disable_cr1=new Pattern("Images/Perfect_Gems/cr1.PNG");
		Pattern disable_credit4=new Pattern("Images/Perfect_Gems/disable_credit4.PNG");
		Pattern autolist=new Pattern("Images/Perfect_Gems/autolist.PNG");
		Pattern astop=new Pattern("Images/Perfect_Gems/spin_stop.PNG");
		Pattern autoplay_disable=new Pattern("Images/Perfect_Gems/autoplay_disable.PNG");
		Pattern info_disable=new Pattern("Images/Perfect_Gems/info_disable.PNG");
		Pattern home_disable=new Pattern("Images/Perfect_Gems/home_disable.PNG");
		Pattern turbo_disable=new Pattern("Images/Perfect_Gems/turbo_disable.PNG");
		Pattern maxbet_disable=new Pattern("Images/Perfect_Gems/maxbet_disable.PNG");
		Pattern paylines_disable=new Pattern("Images/Perfect_Gems/paylines_disable.PNG");
		Pattern maximize_disable=new Pattern("Images/Perfect_Gems/maximize_disable.PNG");
		Pattern hidden_disable=new Pattern("Images/Perfect_Gems/hidden_disable.PNG");
		Pattern bal_disable=new Pattern("Images/Perfect_Gems/bal_disable.PNG");
		Pattern creditdec_disable=new Pattern("Images/Perfect_Gems/creditdec_disable.PNG");
		Pattern betdec_disable=new Pattern("Images/Perfect_Gems/betdec_disable.PNG");
		Pattern auto_auto=new Pattern("Images/Perfect_Gems/auto_auto.PNG");
		Pattern maxbet=new Pattern("Images/Perfect_Gems/maxbet.PNG");
		Pattern ok=new Pattern("Images/Perfect_Gems/ok.PNG");
		Pattern insufficiant=new Pattern("Images/Perfect_Gems/insufficiant.PNG");
		...
		//maxbet button
		Finder finder47 =new Finder(screen.capture().getImage());
		String ht47 = finder47.find(maxbet_disable);
		double score47=20;                
		System.out.println("the value of ht47"+" "+ht47);
		if(finder47.hasNext())
		{
			Match m47=finder47.next();
			System.out.println("Match Found with: "+(m47.getScore())*100+"%");
			score47=(m47.getScore())*100;
			System.out.println("maxbet button is disabled during insufficient alert. Test case passed");
			finder47.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("maxbet button is disabled to click & Comparision value equals to: "+" "+score47 +"%");
		Assert.assertTrue(score47 > 97);
	...
	public void check_for_the_game_buttons_during_the_insufficient_alert_message_in_the_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_after_decrementing_credit_and_trigger_autospin_in_Perfect_Gems_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
