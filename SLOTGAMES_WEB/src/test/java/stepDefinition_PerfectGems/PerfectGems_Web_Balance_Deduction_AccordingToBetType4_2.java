...
public class PerfectGems_Web_Balance_Deduction_AccordingToBetType4_2 {
	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Perfect Gems slot game, bet type as (\\d+)\\.(\\d+), bet value as TWENTY, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Perfect_Gems_slot_game_bet_type_as_bet_value_as_TWENTY_balance_and_spin_button(int arg1, int arg2) throws Throwable {
	...
	public void open_the_Perfect_Gems_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_bet_value_as_TWENTY_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern betval=new Pattern("Images/Perfect_Gems/bet4_2.PNG");
		...
		Pattern Afterspin_bal=new Pattern("Images/Perfect_Gems/balance4_2.PNG");
