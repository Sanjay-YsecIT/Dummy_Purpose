...
public class HappyFruits_Web_Check_CreditBalance_For_Incremental_Decremental_CreditValues {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_increment_decrement_and_balance_balance_in_credit_form_creditvalues() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_inc_and_dec_credit_balance_and_verify_the_balance_in_credit_form_and_verify_the_balance() throws Throwable {
		...
		Pattern credit_balance_1=new Pattern("Images/Happy_Fruits/credit_balance_1.PNG");
		...
		//Incremenet the credit from 0.03 to 1
		...
		//Decrement the credit from 1 to 0.05
	...
	public void credit_balance_for_all_credit_values_should_be_same_as_balance_multiplies_by_credit_value_are_assigned_respectively_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
