...
public class HappyFruits_Web_AutoSpin_InsufficiantBalance_Validation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_AutoSpin_button_validation_message_maxbet_button_credit_decrement_button() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_maxbet_click_on_Autospin_button_till_balance_turns_to_zero_and_check_the_validation_message_and_decrement_the_denomination_and_again_spin_the_reels() throws Throwable {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement TransferInput =	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("transferInput")));
		TransferInput.clear();
		Thread.sleep(1000);
		TransferInput.sendKeys("250");
		Thread.sleep(2000);
		...
		Pattern disable_spin=new Pattern("Images/Happy_Fruits/disable_spin.PNG");
		Pattern disable_bet4_5=new Pattern("Images/Happy_Fruits/disable_bet4_5.PNG");
		Pattern disable_betval=new Pattern("Images/Happy_Fruits/bet_dropdown4.PNG");
		Pattern disable_cr1=new Pattern("Images/Happy_Fruits/cr1.PNG");
		Pattern disable_credit4=new Pattern("Images/Happy_Fruits/disable_credit4.PNG");
		Pattern autolist=new Pattern("Images/Happy_Fruits/autolist.PNG");
		Pattern astop=new Pattern("Images/Happy_Fruits/spin_stop.PNG");
		Pattern autoplay_disable=new Pattern("Images/Happy_Fruits/autoplay_disable.PNG");
		Pattern info_disable=new Pattern("Images/Happy_Fruits/info_disable.PNG");
		Pattern home_disable=new Pattern("Images/Happy_Fruits/home_disable.PNG");
		Pattern turbo_disable=new Pattern("Images/Happy_Fruits/turbo_disable.PNG");
		Pattern paylines_disable=new Pattern("Images/Happy_Fruits/paylines_disable.PNG");
		Pattern maximize_disable=new Pattern("Images/Happy_Fruits/maximize_disable.PNG");
		Pattern hidden_disable=new Pattern("Images/Happy_Fruits/hidden_disable.PNG");
		Pattern bal_disable=new Pattern("Images/Happy_Fruits/bal_disable.PNG");
		Pattern creditdec_disable=new Pattern("Images/Happy_Fruits/creditdec_disable.PNG");
		Pattern betdec_disable=new Pattern("Images/Happy_Fruits/betdec_disable.PNG");
		Pattern auto_auto=new Pattern("Images/Happy_Fruits/auto_auto.PNG");
		Pattern maxbet=new Pattern("Images/Happy_Fruits/maxbet.PNG");
		Pattern ok=new Pattern("Images/Happy_Fruits/ok.PNG");
		Pattern insufficiant=new Pattern("Images/Happy_Fruits/insufficiant.PNG");
		...
		Pattern symb_2=new Pattern("Images/Happy_Fruits/symb_2.PNG");
		...
		if(finder10.hasNext())
		{
			...
			System.out.println("autolist is not present on screen during insufficient alert");
			finder10.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("autolist is not present on screen & Comparision value equals to: "+" "+score10 +"%");
		Assert.assertFalse(score10 > 96);
	...
	public void check_for_the_game_buttons_during_the_insufficient_alert_message_in_the_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_after_decrementing_credit_and_trigger_autospin_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
