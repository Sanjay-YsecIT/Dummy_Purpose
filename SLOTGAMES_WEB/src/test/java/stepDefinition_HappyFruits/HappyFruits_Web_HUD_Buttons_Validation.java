...
public class HappyFruits_Web_HUD_Buttons_Validation {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Happy Fruits slot game, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_HUD_buttons() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_launch_the_game() throws Throwable {
		...
		Pattern HUD=new Pattern("Images/Happy_Fruits/HUD.PNG");
		Pattern spin=new Pattern("Images/Happy_Fruits/spin.PNG");
		Pattern spin_stop=new Pattern("Images/Happy_Fruits/spin_stop.PNG");
		Pattern turboON=new Pattern("Images/Happy_Fruits/turboON.PNG");
		Pattern turboOFF=new Pattern("Images/Happy_Fruits/turboOFF.PNG");
		Pattern hide=new Pattern("Images/Happy_Fruits/hide.PNG");
		Pattern unhide=new Pattern("Images/Happy_Fruits/unhide.PNG");
		Pattern balance_unhide=new Pattern("Images/Happy_Fruits/balance_unhide.PNG");
