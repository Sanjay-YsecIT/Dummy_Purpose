...
public class HappyFruits_Web_Transfer_Validation_EmptyBalance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_empty_balance_text_field_to_transfer_balance_Ok_button_and_validation_message() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_do_not_enter_the_amount_in_the_balance_field_and_click_on_Ok_button() throws Throwable {
		WebElement balT = driver.findElement(By.id("transferInput"));
		 ...
		 //Comparing the amount which is transferring to the slot game
	      Pattern credit1=new Pattern("Images/Happy_Fruits/t_emptybalance.PNG");
	...
	public void an_error_should_be_displayed_if_the_balance_field_is_empty_and_player_should_be_blocked_from_loading_the_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
