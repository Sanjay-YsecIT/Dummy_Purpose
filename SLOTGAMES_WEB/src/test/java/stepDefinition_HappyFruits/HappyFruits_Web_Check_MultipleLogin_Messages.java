...
public class HappyFruits_Web_Check_MultipleLogin_Messages {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_spin_Multiple_login_windows_multiple_login_alert_pop_up() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Happy_Fruits_slot_game_spin_the_reels_and_open_another_session_and_play_the_game_and_return_back_to_older_session_and_play() throws Throwable {
		...
		Pattern multiple_login=new Pattern("Images/Happy_Fruits/multiple_login.PNG");
	...
	public void verify_the_Multiple_Login_alert_message_on_the_screen_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(2000);
	}

	@Then("^Move to new session and play without interruption in Happy Fruits slot game$")
	public void move_to_new_session_and_play_without_interruption_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
