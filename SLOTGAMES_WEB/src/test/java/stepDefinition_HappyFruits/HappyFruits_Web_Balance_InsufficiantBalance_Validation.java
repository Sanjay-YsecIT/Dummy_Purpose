...
public class HappyFruits_Web_Balance_InsufficiantBalance_Validation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_spin_button_and_insufficient_alert_message() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_balance_less_than_bet_value_and_check_the_validation_message() throws Throwable {
		...
		Pattern home=new Pattern("Images/Happy_Fruits/home.PNG");
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_less_balance_in_the_account_in_Happy_Fruits_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Decrease the credit and bet value and again start the spin in Happy Fruits slot game$")
	public void decrease_the_credit_and_bet_value_and_again_start_the_spin_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
