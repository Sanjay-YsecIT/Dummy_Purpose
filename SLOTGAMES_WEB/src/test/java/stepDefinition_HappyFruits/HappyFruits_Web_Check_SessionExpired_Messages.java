...
public class HappyFruits_Web_Check_SessionExpired_Messages {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Happy Fruits slot game, balance, transfer button$")
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_transfer_button() throws Throwable {
		this.driver = HappyFruits_URL_Login.getDriver();
	}

	@When("^Open the Happy Fruits slot game by entering the valid URL in browser, enter the valid login details, transfer the amount, idle the game session for about (\\d+)mins$")
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_idle_the_game_session_for_about_mins(int arg1) throws Throwable {
		...
		Pattern SessionExpired=new Pattern("Images/Happy_Fruits/Session_Expired.PNG");
	...
	public void session_Expired_message_should_display_and_user_has_to_start_new_session_for_game_play_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
