...
public class HappyFruits_Web_Gamble_SuitWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_spin_button_win_amount_gamble_button_card_to_click_for_suit_win_and_suit_win_amount() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_click_on_suit_win_card_in_gamble_page() throws Throwable {
		...
		Pattern heart=new Pattern("Images/Happy_Fruits/heart.PNG");
		Pattern win=new Pattern("Images/Happy_Fruits/win.PNG");
		Pattern lose=new Pattern("Images/Happy_Fruits/lose.PNG");
		Pattern balance_suit_win=new Pattern("Images/Happy_Fruits/balance_suit_win.PNG");
		Pattern balance_suit_lose=new Pattern("Images/Happy_Fruits/balance1_1.PNG");
		Pattern suit_win=new Pattern("Images/Happy_Fruits/suit_win.PNG");

		Pattern pre_gambleamount=new Pattern("Images/Happy_Fruits/gambleamount.PNG");
		Pattern post_suitamount=new Pattern("Images/Happy_Fruits/post_suitamount.PNG");
	...
	@Then("^Suit Win amount\\((\\d+)x\\) should get added to the main balance after win else it should not get added to main balance in the Happy Fruits slot game$")
	public void suit_Win_amount_x_should_get_added_to_the_main_balance_after_win_else_it_should_not_get_added_to_main_balance_in_the_Happy_Fruits_slot_game(int arg1) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
