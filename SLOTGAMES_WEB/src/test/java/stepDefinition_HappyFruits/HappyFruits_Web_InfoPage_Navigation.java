...
public class HappyFruits_Web_InfoPage_Navigation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_balance_info_icon_navigation_icon_exit_icon_payout_paylines_wild_scatter_wheelspin_freespin_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("Images/Happy_Fruits/forward.PNG");
		Pattern backward=new Pattern("Images/Happy_Fruits/backward.PNG");
		Pattern exit=new Pattern("Images/Happy_Fruits/exit.PNG");
		Pattern payout=new Pattern("Images/Happy_Fruits/payout.PNG");
		Pattern betways=new Pattern("Images/Happy_Fruits/betways.PNG");
		Pattern multiplier=new Pattern("Images/Happy_Fruits/multiplier.PNG");
		Pattern gamble=new Pattern("Images/Happy_Fruits/infogamble.PNG");
		Pattern jackpot=new Pattern("Images/Happy_Fruits/jackpot.PNG");
		Pattern gamewindow=new Pattern("Images/Happy_Fruits/gamewindow.PNG");
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("info page is at the multiplier window");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		String ht61 = finder61.find(multiplier);
		double score61=20;                
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
