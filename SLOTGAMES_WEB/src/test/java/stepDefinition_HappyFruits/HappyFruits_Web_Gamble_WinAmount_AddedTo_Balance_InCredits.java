...
public class HappyFruits_Web_Gamble_WinAmount_AddedTo_Balance_InCredits {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_credit_balance_spin_button_credit_win_amount_gamble_button_gamble_amount_in_credits_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_in_credits_after_win() throws Throwable {
		...
		Pattern black=new Pattern("Images/Happy_Fruits/black.PNG");
		Pattern win=new Pattern("Images/Happy_Fruits/win.PNG");
		Pattern lose=new Pattern("Images/Happy_Fruits/lose.PNG");

		Pattern Crpre_gambleamount=new Pattern("Images/Happy_Fruits/Crpre_gambleamount.PNG");
		Pattern Crpost_gambleamount=new Pattern("Images/Happy_Fruits/Crpost_gambleamount.PNG");
		Pattern Crpre_gambletowin=new Pattern("Images/Happy_Fruits/Crpre_gambletowin.PNG");
		Pattern credit_gamble_winbalance=new Pattern("Images/Happy_Fruits/credit_gamble_winbalance.PNG");
		Pattern credit_gamble_winfield=new Pattern("Images/Happy_Fruits/credit_gamble_winfield.PNG");
		...
		if(finder1.hasNext())
		{
			...
			System.out.println("Balance comparision before spin completed successfully. Balance is 10,000");
			finder1.destroy();  
		}         
		else    
		{ 
		...
		else
		{
			...
			if(finder11.hasNext())
			{
				...
				System.out.println("Balance After losing in gamble. Balance is 9,995");
				finder11.destroy();  
			}         
			else    
			{ 
	...
	public void verify_the_credit_form_of_currency_in_gamble_page_on_all_fields_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void gamble_credit_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
