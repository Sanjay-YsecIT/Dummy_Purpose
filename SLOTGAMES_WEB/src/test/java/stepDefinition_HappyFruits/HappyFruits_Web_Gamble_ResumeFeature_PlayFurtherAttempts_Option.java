...
public class HappyFruits_Web_Gamble_ResumeFeature_PlayFurtherAttempts_Option {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_bet_type_denomination_balance_win_symbols_spin_button_Gamble_screen_new_browser() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_click_on_red_button_and_close_the_browser_and_again_login_to_the_game_with_new_browser() throws Throwable {
		...
		Pattern resume_pre_gambleamount=new Pattern("Images/Happy_Fruits/resume_gambleamount.PNG");
		Pattern resume_post_gambleamount=new Pattern("Images/Happy_Fruits/resume_post_gambleamount.PNG");
		Pattern resume_pre_gamblecount=new Pattern("Images/Happy_Fruits/pre_gamblecount.PNG");
		Pattern resume_post_gamblecount=new Pattern("Images/Happy_Fruits/post_gamblecount.PNG");
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Win amount comparision completed successfully. Win amount is 0.30 SRD");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		if  (screen.exists(win) != null)
		{
			...
			FileInputStream objfile = new FileInputStream(System.getProperty("user.dir")+"/HappyFruits.properties");
			obj.load(objfile);

			String gamePath = obj.getProperty("HappyFruits");
	...
	public void resume_feature_should_be_enabled_and_land_on_the_gamble_screen_of_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void verify_the_Gamble_attempts_gamble_amount_and_user_is_able_to_play_left_over_attempts_and_collect_the_win_amount_in_Happy_Fruits_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
