...
public class HappyFruits_Web_Gamble_HomeButtons_Behaviour {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Happy Fruits slot game, spin, gamble link, gamble page, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Happy_Fruits_slot_game_spin_gamble_link_gamble_page_HUD_buttons() throws Throwable {
	...
	public void open_the_Happy_Fruits_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_spin_the_reels_and_access_to_gamble_and_click_on_HUD_buttons_present_on_the_screen() throws Throwable {
		...
		Pattern disable_credit=new Pattern("Images/Happy_Fruits/disable_credit.PNG");
		Pattern disable_betvalue=new Pattern("Images/Happy_Fruits/disable_betvalue.PNG");
		...
		Pattern disable_hidden=new Pattern("Images/Happy_Fruits/disable_hidden.PNG");
		Pattern Afterspin_bal=new Pattern("Images/Happy_Fruits/balance1_1.PNG");
		...
		if(finder31.hasNext())
		{
			...
			System.out.println("After clicking on credit button, credit value is 0.03 is verified on screen. Test case3 passed");
			finder31.destroy();  
		}         
		else    
		{ 
		...
		if(finder5.hasNext())
		{
			...
			System.out.println("After clicking on Bet button, credit value selected is 0.15. Test case4 passed");
			finder5.destroy();  
		}         
		else    
		{ 
	...
	public void all_HUD_buttons_should_be_inactive_upon_click_shoudn_t_perform_any_action_in_Happy_Fruits_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
