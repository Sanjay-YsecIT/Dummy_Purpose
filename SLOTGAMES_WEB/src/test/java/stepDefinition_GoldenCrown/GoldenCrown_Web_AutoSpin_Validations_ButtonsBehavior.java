...
//		String path = System.getProperty("user.dir")+"E:\\Sikuli Images\\AutoSpins.PNG";
		...
		Pattern ahome=new Pattern("Images/GoldenCrown/GC/autoplay_home.png");
		Pattern ainfo=new Pattern("Images/GoldenCrown/GC/autoplay_info.png");
		Pattern acreditvalue=new Pattern("Images/GoldenCrown/GC/autoplay_credit.png");
		Pattern abetvalue=new Pattern("Images/GoldenCrown/GC/autoplay_betvalue.png");
		Pattern astop=new Pattern("Images/GoldenCrown/GC/autoplay_stop.png");
		Pattern betvalue=new Pattern("Images/GoldenCrown/GC/autoplay_betvalue_click.PNG");
		Pattern credit=new Pattern("Images/GoldenCrown/GC/autoplay_creditvalue_click.PNG");
		Pattern bet1_1=new Pattern("Images/GoldenCrown/GC/bet1_1.png");
		Pattern credit1=new Pattern("Images/GoldenCrown/GC/credit1.png");
		Pattern payout1_1=new Pattern("Images/GoldenCrown/GC/payout1_1.png");
		Pattern goodluck=new Pattern("Images/GoldenCrown/GC/goodluck.png");
		Pattern placebet=new Pattern("Images/GoldenCrown/GC/placebet.png");
