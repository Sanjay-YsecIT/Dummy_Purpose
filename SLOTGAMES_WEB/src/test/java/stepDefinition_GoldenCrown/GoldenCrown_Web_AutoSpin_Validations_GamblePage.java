...
public class GoldenCrown_Web_AutoSpin_Validations_GamblePage {
	...
	public void chrome_browser_valid_URL_valid_login_details_Golden_Crown_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page() throws Throwable {
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page() throws Throwable {
		...
		Pattern play=new Pattern("Images/GoldenCrown/GC/autoplay.png");
		Pattern spin=new Pattern("Images/GoldenCrown/GC/spin.png");
		Pattern pat1=new Pattern("Images/GoldenCrown/GC/autospin.png");
		Pattern auto=new Pattern("Images/GoldenCrown/GC/auto.png");
		Pattern astop=new Pattern("Images/GoldenCrown/GC/autoplay_stop.png");
		Pattern credit=new Pattern("Images/GoldenCrown/GC/credit.png");
		Pattern plum=new Pattern("Images/GoldenCrown/GC/plum.png");
		Pattern orange=new Pattern("Images/GoldenCrown/GC/orange.png");
		Pattern gamble=new Pattern("Images/GoldenCrown/GC/gamble.png");
		Pattern collect=new Pattern("Images/GoldenCrown/GC/collect.png");
		Pattern balance_win=new Pattern("Images/GoldenCrown/GC/balance_afterSpin.png");	
		Pattern credit_d=new Pattern("Images/GoldenCrown/GC/credit_d.png");
		Pattern betvalue=new Pattern("Images/GoldenCrown/GC/betvalue.png");
		Pattern credit3=new Pattern("Images/GoldenCrown/GC/credit3.png");
		Pattern bet3_5=new Pattern("Images/GoldenCrown/GC/bet3_5.png");
		Pattern maxbet=new Pattern("Images/GoldenCrown/GC/maxbet.png");
		Pattern ok=new Pattern("Images/GoldenCrown/GC/ok.png");
		Pattern insufficiant=new Pattern("Images/GC/GoldenCrown/insufficiant.png");

		//selecting credit vlaue as 0.5
		screen.wait(spin, 30);
		screen.click(credit);
		Thread.sleep(1000);
		screen.click(credit);
		...
		Pattern balance=new Pattern("Images/GoldenCrown/GC/balance.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Balance after win in auto play is 330.00 and navigating from gamble page & balance comparision completed successfully.");
			finder3.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Balance is 330.00 YSI after win in autoplay and navigating from gamble page & comparision value equal to: "+" "+score3 +"%");
