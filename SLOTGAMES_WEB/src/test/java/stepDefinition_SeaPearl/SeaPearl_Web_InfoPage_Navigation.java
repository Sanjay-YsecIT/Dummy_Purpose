...
public class SeaPearl_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sea_Pearl_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_scatter_free_spin_wild_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/Sea_Pearl/fwd_navigation.PNG");
		Pattern backward=new Pattern("./Images/Sea_Pearl/bckwrd_navigation.PNG");
		Pattern exit=new Pattern("./Images/Sea_Pearl/exit.PNG");
		Pattern payout=new Pattern("./Images/Sea_Pearl/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/Sea_Pearl/paylines_info.PNG");
		Pattern wild=new Pattern("./Images/Sea_Pearl/wild_info.PNG");
		Pattern FreeSpin=new Pattern("./Images/Sea_Pearl/FreeSpin_info.PNG");
		Pattern scatter=new Pattern("./Images/Sea_Pearl/scatter_info.PNG");
		Pattern gamble=new Pattern("./Images/Sea_Pearl/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/Sea_Pearl/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/Sea_Pearl/game_window.PNG");
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Sea_Pearl_slot_game() throws Throwable {
