...
public class SeaPearl_Web_TryNow_CheckBalance {

	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Sea Pearl slot game, try now button and balance to play$")
	public void chrome_browser_valid_URL_valid_login_details_Sea_Pearl_slot_game_try_now_button_and_balance_to_play() throws Throwable {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/ui-view[1]/section[1]/section[1]/div[1]/div[1]/div[2]/div[3]/ul[1]/li[29]/div[2]/div[2]")).click();
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button() throws Throwable {
	...
	public void system_should_provide_five_thousand_as_balance_on_click_on_try_now_button_in_Sea_Pearl_slot_game() throws Throwable {
