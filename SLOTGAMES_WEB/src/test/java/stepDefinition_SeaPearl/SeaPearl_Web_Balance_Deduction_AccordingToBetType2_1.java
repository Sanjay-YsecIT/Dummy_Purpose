...
public class SeaPearl_Web_Balance_Deduction_AccordingToBetType2_1 {

	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Sea Pearl game, (\\d+)\\.(\\d+) as bet type , (\\d+)\\.(\\d+) as bet value, balance, spin button , win amount and balance amount$")
	public void chrome_browser_valid_URL_valid_login_details_Sea_Pearl_game_as_bet_type_as_bet_value_balance_spin_button_win_amount_and_balance_amount(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_value_to_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern Afterspin_bal=new Pattern("./Images/Sea_Pearl/Reminingbal_299.50.PNG");
