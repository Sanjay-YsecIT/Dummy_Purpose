...
public class SeaPearl_Web_WinPattern_Combinations_Matching_PayLinesAndRules {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sea_Pearl_slot_game_bet_type_denomination_balance_available_symbols_spin_button_win_pattern_combinations_and_line_Combinations_win_amount() throws Throwable {
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_reels_win_appears_on_the_screen_and_respective_win_combination_lines_with_win_amount_appear_on_the_goodluck_frame() throws Throwable {
		...
		Pattern win_pattern=new Pattern("./Images/Sea_Pearl/payline_win_pattern.PNG");
		Pattern win1=new Pattern("./Images/Sea_Pearl/pattern_win1.PNG");
		Pattern win2=new Pattern("./Images/Sea_Pearl/pattern_win2.PNG");
		Pattern win3=new Pattern("./Images/Sea_Pearl/pattern_win3.PNG");
		Pattern win4=new Pattern("./Images/Sea_Pearl/pattern_win4.PNG");
	...
	public void win_pattern_should_highlight_on_the_symbols_and_according_to_win_patterns_line_combinations_with_win_amount_should_display_for_each_pattern_wins_on_the_goodluck_frame_of_Sea_Pearl_slot_game() throws Throwable {
