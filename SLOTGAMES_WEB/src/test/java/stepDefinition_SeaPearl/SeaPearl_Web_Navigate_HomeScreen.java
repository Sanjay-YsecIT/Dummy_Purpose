...
public class SeaPearl_Web_Navigate_HomeScreen {
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button() throws Throwable {
		...
		Pattern Home_Screen_Logo=new Pattern("./Images/Sea_Pearl/suribet_logo.PNG");
		Pattern Sea_Pearl=new Pattern("./Images/Sea_Pearl/SP_logo.PNG");
		Pattern home=new Pattern("./Images/Sea_Pearl/home.PNG");

		//Comparing whether Sea_Pearl  game is loaded and home button is visible
		// Pattern credit1=new Pattern("E:/Sikuli Images/others/goldenhot.png");

		Finder finder =new Finder(screen.capture().getImage());
		String ht = finder.find(Sea_Pearl);
		double score=20;                
		...
		if(finder.hasNext())
		{
			...
			System.out.println("Sea Pearl game is loaded and comparision successfull.");
			finder.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Sea Pearl is loaded and comparision value equals to: "+" "+score +"%");
		...
		//After clicking on home button, Sea Pearl game should not be visible
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Navigate to the home screen & Sea Pearl home page should not be visible and comparision successfull.");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Navigate to the home screen of the Sea Pearl slot games and comparision value is equal to: "+" "+score2 +"%");
