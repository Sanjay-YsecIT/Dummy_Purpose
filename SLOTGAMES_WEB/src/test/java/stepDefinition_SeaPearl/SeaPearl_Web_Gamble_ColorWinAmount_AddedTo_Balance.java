...
public class SeaPearl_Web_Gamble_ColorWinAmount_AddedTo_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sea_Pearl_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_black_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Sea_Pearl_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_gamble_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern black_btn=new Pattern("./Images/Sea_Pearl/gb_black_btn.PNG");
		Pattern gamble_btn=new Pattern("./Images/Sea_Pearl/gb_button.PNG");
		Pattern gb_win=new Pattern("./Images/Sea_Pearl/gb_win.PNG");
		Pattern gb_collect=new Pattern("./Images/Sea_Pearl/gb_collect.PNG");
		Pattern win_bal=new Pattern("./Images/Sea_Pearl/gb_winamt_add.PNG");
		Pattern gb_lose=new Pattern("./Images/Sea_Pearl/gb_loose.PNG");
		Pattern lose_bal=new Pattern("./Images/Sea_Pearl/Reminingbal_299.80.PNG");
	...
	public void gamble_double_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Sea_Pearl_slot_game() throws Throwable {
