...
public class TwentyGlowingHot_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_TwentyGlowing_Hot_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_scatter_dollar_scatter_star_wild_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_TwentyGlowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern settings=new Pattern("./Images/20Glowing_Hot/settings_icon.PNG");
		Pattern info=new Pattern("./Images/20Glowing_Hot/info_icon.PNG");
		Pattern forward=new Pattern("./Images/20Glowing_Hot/fwd_navigation.PNG");
		Pattern backward=new Pattern("./Images/20Glowing_Hot/bckwrd_navigation.PNG");
		Pattern exit=new Pattern("./Images/20Glowing_Hot/exit.PNG");
		Pattern payout=new Pattern("./Images/20Glowing_Hot/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/20Glowing_Hot/paylines_info.PNG");
		Pattern scatter_dollar=new Pattern("./Images/20Glowing_Hot/scatterdollar_info.PNG");
		Pattern scatter_star=new Pattern("./Images/20Glowing_Hot/scatterstar_info.PNG");
		Pattern wild=new Pattern("./Images/20Glowing_Hot/wild_info.PNG");
		Pattern gamble=new Pattern("./Images/20Glowing_Hot/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/20Glowing_Hot/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/20Glowing_Hot/game_window.PNG");
		...
		//	click on forward icon available on the info page to move to scatter-dollar window
		screen.click(forward);
		Thread.sleep(1000);

		Finder finder2 =new Finder(screen.capture().getImage());
		String ht2 = finder2.find(scatter_dollar);
		double score2=20;                
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("info page is at the scatter-dollar window");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		//		click on forward icon available on the info page to move to scatter-star window
		screen.click(forward);
		Thread.sleep(1000);

		Finder finder22 =new Finder(screen.capture().getImage());
		String ht22 = finder22.find(scatter_star);
		double score22=20;                
		...
		if(finder22.hasNext())
		{
			...
			System.out.println("info page is at the scatter-star window");
			finder22.destroy();  
		}         
		else    
		{ 
		...
		String ht23 = finder23.find(scatter_star);
		double score23=20;                
		...
		//	click on backward icon available on the info page to move to scatter-dollar window
		screen.click(backward);
		Thread.sleep(1000);

		Finder finder8 =new Finder(screen.capture().getImage());
		String ht8 = finder8.find(scatter_dollar);
		double score8=20;                
		...
		if(finder8.hasNext())
		{
			...
			System.out.println("info page is at scatter-dollar window");
			finder8.destroy();  
		}         
		else    
		{ 
		...
		String ht10 = finder10.find(paylines);
		double score10=20;                
		...
		String ht12 = finder12.find(payout);
		double score12=20;                
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_TwentyGlowing_Hot_slot_game() throws Throwable {
