...
public class GoldenHot_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Golden_Hot_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_multiplier_feature_paylines_gamble_and_mega_star_jackpot_window() throws Throwable {
	...
	public void open_the_Golden_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/Golden_Hot/fwd_navigation.PNG");
		Pattern backward=new Pattern("./Images/Golden_Hot/bckwrd_navigation.PNG");
		Pattern exit=new Pattern("./Images/Golden_Hot/exit.PNG");
		Pattern payout=new Pattern("./Images/Golden_Hot/PO_info.PNG");
		Pattern multiplier=new Pattern("./Images/Golden_Hot/multiplier_info.PNG");
		Pattern paylines=new Pattern("./Images/Golden_Hot/paylines_info.PNG");
		Pattern gamble=new Pattern("./Images/Golden_Hot/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/Golden_Hot/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/Golden_Hot/game_window.PNG");

		//	click on info icon to move to info window
		screen.click(info);
		Thread.sleep(1000);
		...
		//click on forward icon available on the info page to move to multiplier feature window
		screen.click(forward);
		Thread.sleep(1000);

		Finder finder2 =new Finder(screen.capture().getImage());
		String ht2 = finder2.find(multiplier);
		double score2=20;                
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("info page is at the multiplier feature window");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		//click on backward icon available on the info page to move to multiplier feature window
		screen.click(backward);
		Thread.sleep(1000);

		Finder finder22 =new Finder(screen.capture().getImage());
		String ht22 = finder22.find(multiplier);
		double score22=20;                
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Golden_Hot_slot_game() throws Throwable {
