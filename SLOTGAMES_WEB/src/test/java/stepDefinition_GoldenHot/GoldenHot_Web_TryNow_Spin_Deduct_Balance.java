...
public class GoldenHot_Web_TryNow_Spin_Deduct_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Golden_Hot_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
	...
	public void open_the_Golden_Hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {

		Pattern Trynow_bal=new Pattern("./Images/Golden_Hot/Try_now_bal.PNG");
		Pattern BalAfterSpin=new Pattern("./Images/Golden_Hot/TN_BalAfterspin.PNG");
		Pattern Spin=new Pattern("./Images/Golden_Hot/TN_Spin.PNG");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Golden_Hot_slot_game() throws Throwable {
