...
public class CircusMania_Web_Gamble_ResumeFeature_disabled_Option {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_bet_type_denomination_balance_win_symbols_spin_button_Gamble_screen_new_browser_gamble_attempts() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_close_the_browser_and_again_login_to_the_game_with_new_browser() throws Throwable {
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Win amount comparision completed successfully. Win amount is 0.20");
			finder2.destroy();  
		}         
		else    
		{ 
	...
	public void resume_feature_should_not_be_enabled_and_land_on_the_game_screen_of_Circus_Mania_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
