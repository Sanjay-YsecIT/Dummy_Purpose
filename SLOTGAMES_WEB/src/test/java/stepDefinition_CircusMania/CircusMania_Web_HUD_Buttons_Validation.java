...
public class CircusMania_Web_HUD_Buttons_Validation {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Circus Mania slot game, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_HUD_buttons() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_launch_the_game() throws Throwable {
		...
		Pattern HUD=new Pattern("Images/Circus_Mania/HUD.PNG");
		Pattern spin=new Pattern("Images/Circus_Mania/spin.PNG");
		Pattern spin_stop=new Pattern("Images/Circus_Mania/spin_stop.PNG");
		Pattern turboON=new Pattern("Images/Circus_Mania/turboON.PNG");
		Pattern turboOFF=new Pattern("Images/Circus_Mania/turboOFF.PNG");
		Pattern hide=new Pattern("Images/Circus_Mania/hide.PNG");
		Pattern unhide=new Pattern("Images/Circus_Mania/unhide.PNG");
		Pattern balance_unhide=new Pattern("Images/Circus_Mania/balance_unhide.PNG");
		Pattern balance_hide=new Pattern("Images/Circus_Mania/balance_hide.PNG");
