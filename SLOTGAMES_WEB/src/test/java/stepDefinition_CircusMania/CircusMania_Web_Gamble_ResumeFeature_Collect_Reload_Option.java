...
public class CircusMania_Web_Gamble_ResumeFeature_Collect_Reload_Option {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slotCircus_Mania_slot_game_bet_type_denomination_balance_win_symbols_spin_button_Gamble_screen_collect_new_browser() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_close_the_browser_and_again_login_to_the_game_with_new_browser_window() throws Throwable {
		...
		Pattern resgamble_win=new Pattern("Images/Circus_Mania/resgamble_win.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			//Verify the black button after reloading the Circus Mania slot game
			...
			//Verify the black button after resuming the Circus Mania slot game
	...
	public void resume_feature_should_be_enabled_and_land_on_the_game_screen_and_collect_the_win_amount_in_Circus_Mania_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Verify the reload option after gamble win in Circus Mania slot game$")
	public void verify_the_reload_option_after_gamble_win_in_Circus_Mania_slot_game() throws Throwable {
		Thread.sleep(100);
		driver.quit();
	}
}
