...
public class CircusMania_Web_Gamble_ColorWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_black_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_gamble_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern win_1 = new Pattern("Images/Circus_Mania/win_1.PNG");            
		...
		Pattern balance_gamble_win=new Pattern("Images/Circus_Mania/balance_gamble_win.PNG");
		Pattern balance_gamble_lose=new Pattern("Images/Circus_Mania/balance1_1.PNG");
		Pattern gamble_win=new Pattern("Images/Circus_Mania/gamble_win.PNG");

		Pattern pre_gambleamount=new Pattern("/Images/Circus_Mania/gambleamount.PNG");
		Pattern post_gambleamount=new Pattern("/Images/Circus_Mania/post_gambleamount.PNG");
	...
	public void gamble_double_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Circus_Mania_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^After (\\d+)st win gamble amount is doubled and available for next gamble in Circus Mania slot game$")
	public void after_st_win_gamble_amount_is_doubled_and_available_for_next_gamble_in_Circus_Mania_slot_game(int arg1) throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
