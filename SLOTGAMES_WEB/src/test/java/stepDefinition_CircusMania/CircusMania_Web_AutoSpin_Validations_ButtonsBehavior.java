...
public class CircusMania_Web_AutoSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern autoicon=new Pattern("Images/Circus_Mania/autoplay.PNG");
		...
		Pattern auto_home=new Pattern("Images/Circus_Mania/disable_home.PNG");
		Pattern auto_info=new Pattern("Images/Circus_Mania/disable_info.PNG");
		Pattern auto_lines=new Pattern("Images/Circus_Mania/disable_lines.PNG");
		Pattern auto_turbo=new Pattern("Images/Circus_Mania/disable_turbo.PNG");
		Pattern auto_credit=new Pattern("Images/Circus_Mania/disable_credit.PNG");
		Pattern auto_betvalue=new Pattern("Images/Circus_Mania/disable_betvalue.PNG");
		Pattern auto_betvalue_click=new Pattern("Images/Circus_Mania/disable_betvalue_click.PNG");
		Pattern auto_credit_click=new Pattern("Images/Circus_Mania/disable_credit_click.PNG");
		Pattern bet=new Pattern("Images/Circus_Mania/bet1.PNG");
		Pattern payout1_1=new Pattern("Images/Circus_Mania/payout1_1.PNG");
		Pattern placebet=new Pattern("Images/Circus_Mania/placebet.PNG");
		...
		//Comparing the paylines button on disabled button and it should be 20
		...
		if(finder31.hasNext())
		{
			...
			System.out.println("After clicking on paylines button paylines is 20. Test case3 passed");
			finder31.destroy();  
		}         
		else    
		{ 
