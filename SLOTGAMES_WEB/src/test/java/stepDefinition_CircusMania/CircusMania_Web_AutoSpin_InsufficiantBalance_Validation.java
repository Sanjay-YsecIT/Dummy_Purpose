...
public class CircusMania_Web_AutoSpin_InsufficiantBalance_Validation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Circus_Mania_slot_game_balance_AutoSpin_button_validation_message_maxbet_button_credit_decrement_button() throws Throwable {
	...
	public void open_the_Circus_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_maxbet_click_on_Autospin_button_till_balance_turns_to_zero_and_check_the_validation_message_and_decrement_the_denomination_and_again_spin_the_reels() throws Throwable {
		...
		Pattern disable_bet4_5=new Pattern("Images/Circus_Mania/disable_bet4_5.PNG");
		Pattern disable_betval=new Pattern("Images/Circus_Mania/disable_betval.PNG");
		Pattern disable_cr1=new Pattern("Images/Circus_Mania/cr1.PNG");
		Pattern disable_credit4=new Pattern("Images/Circus_Mania/disable_credit4.PNG");
		Pattern autolist=new Pattern("Images/Circus_Mania/autolist.PNG");
		Pattern astop=new Pattern("Images/Circus_Mania/spin_stop.PNG");
		Pattern autoplay_disable=new Pattern("Images/Circus_Mania/autoplay_disable.PNG");
		Pattern info_disable=new Pattern("Images/Circus_Mania/info_disable.PNG");
		Pattern home_disable=new Pattern("Images/Circus_Mania/home_disable.PNG");
		Pattern turbo_disable=new Pattern("Images/Circus_Mania/turbo_disable.PNG");
		Pattern paylines_disable=new Pattern("Images/Circus_Mania/paylines_disable.PNG");
		Pattern maximize_disable=new Pattern("Images/Circus_Mania/maximize_disable.PNG");
		Pattern hidden_disable=new Pattern("Images/Circus_Mania/hidden_disable.PNG");
		Pattern bal_disable=new Pattern("Images/Circus_Mania/bal_disable.PNG");
		Pattern creditdec_disable=new Pattern("Images/Circus_Mania/creditdec_disable.PNG");
		Pattern betdec_disable=new Pattern("Images/Circus_Mania/betdec_disable.PNG");
		Pattern auto_auto=new Pattern("Images/Circus_Mania/auto_auto.PNG");
		Pattern maxbet=new Pattern("Images/Circus_Mania/maxbet.PNG");
		Pattern ok=new Pattern("Images/Circus_Mania/ok.PNG");
		Pattern insufficiant=new Pattern("Images/Circus_Mania/insufficiant.PNG");
		Pattern credit_dec=new Pattern("Images/Circus_Mania/credit_dec.PNG");
		Pattern bet_dec=new Pattern("Images/Circus_Mania/bet_dec.PNG");
	...
	public void check_for_the_game_buttons_during_the_insufficient_alert_message_in_the_Circus_Mania_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
