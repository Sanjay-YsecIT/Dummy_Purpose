...
public class GummyLand_Web_AutoSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern autoicon=new Pattern("Images/Gummy_Land/autoplay.PNG");
		...
		Pattern auto_home=new Pattern("Images/Gummy_Land/disable_home.PNG");
		Pattern auto_info=new Pattern("Images/Gummy_Land/disable_info.PNG");
		Pattern auto_lines=new Pattern("Images/Gummy_Land/disable_lines.PNG");
		Pattern auto_turbo=new Pattern("Images/Gummy_Land/disable_turbo.PNG");
		Pattern auto_credit=new Pattern("Images/Gummy_Land/disable_credit1.PNG");
		Pattern auto_betvalue=new Pattern("Images/Gummy_Land/disable_betvalue.PNG");
		Pattern betdropdown=new Pattern("Images/Gummy_Land/bet_dropdown1.PNG");
		Pattern auto_betvalue_click=new Pattern("Images/Gummy_Land/disable_betvalue_click.PNG");
		Pattern auto_credit_click=new Pattern("Images/Gummy_Land/disable_credit_click.PNG");
		Pattern bet=new Pattern("Images/Gummy_Land/bet1.PNG");
		Pattern payout1_1=new Pattern("Images/Gummy_Land/payout1_1.PNG");
		Pattern placebet=new Pattern("Images/Gummy_Land/placebet.PNG");
		Pattern credit1=new Pattern("Images/Gummy_Land/cr1.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("After clicking on credit button, credit value selected is 0.02. Test case3 passed");
			finder3.destroy();  
		}         
		else    
		{ 
