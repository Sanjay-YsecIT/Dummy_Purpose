...
public class GummyLand_Web_Transfer_Validation_MoreThanAvailableBalance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_greater_than_available_balance_text_field_to_transfer_balance_Ok_button_and_validation_message() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_greater_than_available_balance_and_click_on_Ok_button() throws Throwable {
		...
		Pattern credit1=new Pattern("Images/Gummy_Land/t_morebalance.PNG");
	...
	public void player_should_be_blocked_from_loading_the_Gummy_Land_slot_game_when_the_amount_entered_in_the_transfer_page_is_more_than_the_available_balance() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
