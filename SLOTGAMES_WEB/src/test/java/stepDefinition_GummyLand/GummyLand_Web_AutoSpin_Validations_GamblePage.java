...
public class GummyLand_Web_AutoSpin_Validations_GamblePage {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page() throws Throwable {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement TransferInput =	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("transferInput")));
		TransferInput.clear();
		Thread.sleep(1000);
		TransferInput.sendKeys("150");
		Thread.sleep(2000);
		...
		Pattern balance=new Pattern("Images/Gummy_Land/insufficient_balance.PNG");
		Pattern balance_afterspin=new Pattern("Images/Gummy_Land/balance_afterspin.PNG");
		Pattern credit3=new Pattern("Images/Gummy_Land/credit3.PNG");
		Pattern bet3_5=new Pattern("Images/Gummy_Land/bet3_5.PNG");
		...
		/*Checking the balance after win & navigating from gamble page
		  ...
		  balance before spin-295
		  win amount is 45 and it is added to main balance after collecting from gamble page hence new bal is 340
		 * 340 is at main balance and after next spin balance is 335 in main balance field
		 * Hence 335 is taken consideration for win amount added to balance during autospin returning from gamble
		 */
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Balance after win in auto play is 335 and navigating from gamble page & balance comparision completed successfully.");
			finder3.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Balance is 335 SRD after win in autoplay and navigating from gamble page & comparision value equal to: "+" "+score3 +"%");
	...
	public void bet_value_Credit_value_buttons_should_be_clickable_after_navigating_from_gamble_page_when_autospin_is_stopped_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
