...
public class GummyLand_Web_Gamble_WinAmount_AddedTo_Balance_InCredits {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_credit_balance_spin_button_credit_win_amount_gamble_button_gamble_amount_in_credits_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_in_credits_after_win() throws Throwable {
		...
		Pattern balance_credits_1=new Pattern("Images/Gummy_Land/balance_credits_1.PNG");
		Pattern credit_deductbal=new Pattern("Images/Gummy_Land/balance_crdeduct_1.PNG");
		Pattern gamble=new Pattern("Images/Gummy_Land/gamble.PNG");
		Pattern collect=new Pattern("Images/Gummy_Land/collect.PNG");

		Pattern black=new Pattern("Images/Gummy_Land/black.PNG");
		Pattern win=new Pattern("Images/Gummy_Land/win.PNG");
		Pattern lose=new Pattern("Images/Gummy_Land/lose.PNG");

		Pattern Crpre_gambleamount=new Pattern("Images/Gummy_Land/Crpre_gambleamount.PNG");
		Pattern Crpost_gambleamount=new Pattern("Images/Gummy_Land/Crpost_gambleamount.PNG");
		Pattern Crpre_gambletowin=new Pattern("Images/Gummy_Land/Crpre_gambletowin.PNG");
		Pattern credit_gamble_winbalance=new Pattern("Images/Gummy_Land/credit_gamble_winbalance.PNG");
		Pattern credit_gamble_winfield=new Pattern("Images/Gummy_Land/credit_gamble_winfield.PNG");
		...
		if(finder1.hasNext())
		{
			...
			System.out.println("Balance comparision before spin completed successfully. Balance is 15,000");
			finder1.destroy();  
		}         
		else    
		{ 
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Win amount comparision completed successfully. Win amount is 90");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 90 and gamble amount is 30 after 1st win gamble amount is "180"
	...
	public void verify_the_credit_form_of_currency_in_gamble_page_on_all_fields_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void gamble_credit_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
