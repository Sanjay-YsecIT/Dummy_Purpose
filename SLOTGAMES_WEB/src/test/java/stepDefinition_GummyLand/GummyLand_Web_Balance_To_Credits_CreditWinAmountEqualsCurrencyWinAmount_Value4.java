...
public class GummyLand_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value4 {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_four() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_four_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern win_4 = new Pattern("Images/Gummy_Land/win_4.PNG");
		Pattern win_41 = new Pattern("Images/Gummy_Land/win_41.PNG");
		Pattern balance4_1=new Pattern("Images/Gummy_Land/balance4_1.PNG");

		// credit values
		Pattern credit4_CR = new Pattern("Images/Gummy_Land/credit4_CR.PNG");
	...
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_four_is_equal_to_win_amount_in_currency_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
