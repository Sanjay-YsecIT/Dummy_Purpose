...
public class GummyLand_Web_Gamble_ColorWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_black_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_gamble_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern balance_gamble_win=new Pattern("Images/Gummy_Land/balance_gamble_win.PNG");
		Pattern balance_gamble_lose=new Pattern("Images/Gummy_Land/balance1_1.PNG");
		Pattern gamble_win=new Pattern("Images/Gummy_Land/gamble_win.PNG");

		Pattern pre_gambleamount=new Pattern("Images/Gummy_Land/gambleamount.PNG");
		Pattern post_gambleamount=new Pattern("Images/Gummy_Land/post_gambleamount.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 1.80 and gamble to win amount is 3.60
			//after 1st win gamble amount is "3.60 SRD"
	...
	public void gamble_double_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^After (\\d+)st win gamble amount is doubled and available for next gamble in Gummy Land slot game$")
	public void after_st_win_gamble_amount_is_doubled_and_available_for_next_gamble_in_Gummy_Land_slot_game(int arg1) throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
