...
public class GummyLand_Web_AutoSpin_TwentySpins {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_auto_spin_button_twenty_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_twenty_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern auto_20=new Pattern("Images/Gummy_Land/auto_20.PNG");  

		Pattern pat2=new Pattern("Images/Gummy_Land/19spins.PNG"); 
		Pattern pat3=new Pattern("Images/Gummy_Land/17spins.PNG"); 
		Pattern pat4=new Pattern("Images/Gummy_Land/15spins.PNG"); 
		Pattern pat5=new Pattern("Images/Gummy_Land/13spins.PNG"); 
		Pattern pat6=new Pattern("Images/Gummy_Land/11spins.PNG"); 
		Pattern pat7=new Pattern("Images/Gummy_Land/9spins.PNG");  
		Pattern pat8=new Pattern("Images/Gummy_Land/7spins.PNG");  
		Pattern pat10=new Pattern("Images/Gummy_Land/2spins.PNG"); 
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking twenty spins option and should perform (\\d+) spins from (\\d+) to (\\d+) in Gummy Land slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_twenty_spins_option_and_should_perform_spins_from_to_in_Gummy_Land_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
