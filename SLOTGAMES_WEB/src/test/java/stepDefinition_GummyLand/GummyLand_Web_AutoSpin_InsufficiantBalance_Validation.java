...
public class GummyLand_Web_AutoSpin_InsufficiantBalance_Validation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_AutoSpin_button_validation_message_maxbet_button_credit_decrement_button() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_maxbet_click_on_Autospin_button_till_balance_turns_to_zero_and_check_the_validation_message_and_decrement_the_denomination_and_again_spin_the_reels() throws Throwable {
		...
		Pattern disable_bet4_5=new Pattern("Images/Gummy_Land/disable_bet4_5.PNG");
		Pattern disable_betval=new Pattern("Images/Gummy_Land/bet_dropdown4.PNG");
		Pattern disable_cr1=new Pattern("Images/Gummy_Land/cr1.PNG");
		Pattern disable_credit4=new Pattern("Images/Gummy_Land/disable_credit4.PNG");
		Pattern autolist=new Pattern("Images/Gummy_Land/autolist.PNG");
		Pattern astop=new Pattern("Images/Gummy_Land/spin_stop.PNG");
		Pattern autoplay_disable=new Pattern("Images/Gummy_Land/autoplay_disable.PNG");
		Pattern info_disable=new Pattern("Images/Gummy_Land/info_disable.PNG");
		Pattern home_disable=new Pattern("Images/Gummy_Land/home_disable.PNG");
		Pattern turbo_disable=new Pattern("Images/Gummy_Land/turbo_disable.PNG");
		Pattern maxbet_disable=new Pattern("Images/Gummy_Land/maxbet_disable.PNG");
		Pattern paylines_disable=new Pattern("Images/Gummy_Land/paylines_disable.PNG");
		Pattern maximize_disable=new Pattern("Images/Gummy_Land/maximize_disable.PNG");
		Pattern hidden_disable=new Pattern("Images/Gummy_Land/hidden_disable.PNG");
		Pattern bal_disable=new Pattern("Images/Gummy_Land/bal_disable.PNG");
		Pattern creditdec_disable=new Pattern("Images/Gummy_Land/creditdec_disable.PNG");
		Pattern betdec_disable=new Pattern("Images/Gummy_Land/betdec_disable.PNG");
		Pattern auto_auto=new Pattern("Images/Gummy_Land/auto_auto.PNG");
		Pattern maxbet=new Pattern("Images/Gummy_Land/maxbet.PNG");
		Pattern ok=new Pattern("Images/Gummy_Land/ok.PNG");
		Pattern insufficiant=new Pattern("Images/Gummy_Land/insufficiant.PNG");
		Pattern credit_dec=new Pattern("Images/Gummy_Land/credit_dec.PNG");
		...
		Pattern symb_2=new Pattern("Images/Gummy_Land/symb_2.PNG");
		Pattern symb_3=new Pattern("Images/Gummy_Land/symb_3.PNG");
	...
	public void check_for_the_game_buttons_during_the_insufficient_alert_message_in_the_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_after_decrementing_credit_and_trigger_autospin_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
