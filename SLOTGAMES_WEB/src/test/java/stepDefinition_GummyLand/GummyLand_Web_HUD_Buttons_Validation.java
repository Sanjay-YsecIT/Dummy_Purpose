...
public class GummyLand_Web_HUD_Buttons_Validation {
	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Gummy Land slot game, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_HUD_buttons() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_launch_the_game() throws Throwable {
		...
		Pattern HUD=new Pattern("Images/Gummy_Land/HUD.PNG");
		Pattern spin=new Pattern("Images/Gummy_Land/spin.PNG");
		Pattern spin_stop=new Pattern("Images/Gummy_Land/spin_stop.PNG");
		Pattern turboON=new Pattern("Images/Gummy_Land/turboON.PNG");
		Pattern turboOFF=new Pattern("Images/Gummy_Land/turboOFF.PNG");
		Pattern hide=new Pattern("Images/Gummy_Land/hide.PNG");
		Pattern unhide=new Pattern("Images/Gummy_Land/unhide.PNG");
		Pattern balance_unhide=new Pattern("Images/Gummy_Land/balance_unhide.PNG");
