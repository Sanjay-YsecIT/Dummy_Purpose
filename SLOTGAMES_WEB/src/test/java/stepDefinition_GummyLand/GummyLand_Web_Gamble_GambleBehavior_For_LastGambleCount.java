...
public class GummyLand_Web_Gamble_GambleBehavior_For_LastGambleCount {
	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Gummy Land slot game, bet type as (\\d+)\\.(\\d+), denomination as (\\d+)\\.(\\d+), balance, spin button, win amount, gamble button, gamble amount, red button, win amount field in main page$")
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_bet_type_as_denomination_as_balance_spin_button_win_amount_gamble_button_gamble_amount_red_button_win_amount_field_in_main_page(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		this.driver = GummyLand_URL_Login.getDriver();
	}

	@When("^Open the Gummy Land slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on Gummy Land slot game, select bet type as (\\d+)\\.(\\d+) & denomination as (\\d+)\\.(\\d+), click on spin button till user wins, click on gamble button and pay gamble with last gamble count$")
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Gummy_Land_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_user_wins_click_on_gamble_button_and_pay_gamble_with_last_gamble_count(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		Pattern gamble_winfield=new Pattern("Images/Gummy_Land/gamble_winfield.PNG");
		Pattern lose_balance=new Pattern("Images/Gummy_Land/balance1_1.PNG");
		Pattern main_bal=new Pattern("Images/Gummy_Land/main_bal.PNG");
		Pattern lose_field=new Pattern("Images/Gummy_Land/lose_field.PNG");

		Pattern red=new Pattern("Images/Gummy_Land/red.PNG");
		Pattern win=new Pattern("Images/Gummy_Land/win.PNG");
		Pattern lose=new Pattern("Images/Gummy_Land/lose.PNG");
	...
	public void gamble_page_should_terminate_and_win_amount_should_be_added_to_main_balance_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
