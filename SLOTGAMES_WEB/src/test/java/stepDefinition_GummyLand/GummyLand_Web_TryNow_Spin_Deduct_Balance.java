...
public class GummyLand_Web_TryNow_Spin_Deduct_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
		...
		screen.wait("Images/Gummy_Land/TryNow_spin.PNG", 120);
	}

	@When("^Open the Gummy Land slot game by entering the valid URL in browser, click on try now button and click on spin button$")
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {
		Pattern TryNow_bal=new Pattern("Images/Gummy_Land/TryNow_balance.PNG");
		Pattern BalAfterSpin=new Pattern("Images/Gummy_Land/TN_balance1_1.PNG");
		Pattern spin=new Pattern("Images/Gummy_Land/TryNow_spin.PNG");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
