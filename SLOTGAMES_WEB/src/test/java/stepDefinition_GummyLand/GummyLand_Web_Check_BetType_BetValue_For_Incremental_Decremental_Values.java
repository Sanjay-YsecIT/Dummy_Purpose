...
public class GummyLand_Web_Check_BetType_BetValue_For_Incremental_Decremental_Values {
	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Gummy Land slot game, betvalues, credit increment and decremental$")
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_betvalues_credit_increment_and_decremental() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_credit_incremental_and_decrement() throws Throwable {
		...
		if(finder12.hasNext())
		{
			...
			System.out.println("decrement Credit value and Comparision happened successfully. Available denominations are: 0.5, 1, 2.5, 5 & 10. Test case passed");
			finder12.destroy();  
		}         
		else    
		{ 
	...
	public void verify_the_bet_values_are_in_assigned_fields_in_ascending_order_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
