...
public class GummyLand_Web_Gamble_WinAmount_SameAs_GambleAmount {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_balance_spin_button_win_amount_gamble_button_gamble_page_and_gamble_amount() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_amount_on_web() throws Throwable {
		...
		Pattern gambleamount=new Pattern("Images/Gummy_Land/gambleamount.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Gamble Win amount comparision completed successfully. Gamble Win amount is 1.80 SRD");
			finder3.destroy();  
		}         
		else    
		{ 
	...
	public void win_amount_should_be_displayed_as_Gamble_amount_in_the_gamble_page_of_the_Gummy_Land_slot_game_on_web() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
