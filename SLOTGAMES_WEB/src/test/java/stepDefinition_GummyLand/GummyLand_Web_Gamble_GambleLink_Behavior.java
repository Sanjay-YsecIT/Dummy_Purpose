...
public class GummyLand_Web_Gamble_GambleLink_Behavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Gummy_Land_slot_game_spin_gamble_link_gamble_page_credit_and_bet_values() throws Throwable {
	...
	public void open_the_Gummy_Land_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_onGummy_Land_slot_game_spin_the_reels_and_access_to_gamble_link_and_change_the_bet_and_credit_values() throws Throwable {
		...
		Pattern bet1_2=new Pattern("Images/Gummy_Land/bet1_2.PNG");
		...
		Pattern cr2=new Pattern("Images/Gummy_Land/cr2.PNG");
	...
	public void verify_the_gamble_link_active_and_inactive_state_as_changed_bet_and_credit_values_in_Gummy_Land_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
