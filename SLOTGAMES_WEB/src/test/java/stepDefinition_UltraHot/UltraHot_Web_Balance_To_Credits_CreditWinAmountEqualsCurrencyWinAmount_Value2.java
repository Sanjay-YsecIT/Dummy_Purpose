...
public class UltraHot_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_denomination_drop_down_value_two_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern win_amt = new Pattern("./Images/Ultra_Hot/winamt_2.PNG");
		Pattern balance=new Pattern("./Images/Ultra_Hot/Reminingbal_299.75.PNG");
		Pattern credit_inc = new Pattern("./Images/Ultra_Hot/credit_inc.PNG");

		// credit values
		Pattern win_cr = new Pattern("./Images/Ultra_Hot/cr_winamt1.PNG");
		Pattern balance_cr=new Pattern("./Images/Ultra_Hot/cr_bal2.PNG");
