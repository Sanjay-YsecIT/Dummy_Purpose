...
public class UltraHot_Web_Gamble_GambleCount_For_BetType_4_And_Denomination_4 {
	...
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_amount_to_transfer_transfer_button_bet_type_as_ONE_denomination_as_FIFTY_balance_spin_button_win_amount_gamble_button_gamble_amount_game_info_page_and_gamble_count() throws Throwable {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_transfer_the_balance_click_on_Ultra_Hot_slot_game_transfer_the_amount_select_bet_type_as_ONE_denomination_as_FIFTY_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count() throws Throwable {
		...
		Pattern WIN_AMT3=new Pattern("./Images/Ultra_Hot/win_400.PNG");    // 3st WIN AMOUNT WITH GAMBLE ATTEMPTS 3
		Pattern WIN_AMT4=new Pattern("./Images/Ultra_Hot/win_800.PNG");    // 4st WIN AMOUNT WITH GAMBLE ATTEMPTS 2
		Pattern WIN_AMT5=new Pattern("./Images/Ultra_Hot/win_1200.PNG");    // 5st WIN AMOUNT WITH GAMBLE ATTEMPTS 1
		Pattern WIN_AMT6=new Pattern("./Images/Ultra_Hot/win_2000.PNG");    // 6st WIN AMOUNT WITH GAMBLE ATTEMPTS 0
	...
	public void gamble_count_should_be_displayed_based_on_win_amount_and_max_amount_of_the_gamble_configured_on_the_game_info_page_for_bet_type_ONE_and_denomination_FIFTY_in_Ultra_Hot_game() throws Throwable {
