...
public class UltraHot_Web_Balance_Deduction_AccordingToBetType4_4 {
	...
	@Given("^Chrome browser, valid URL, valid login details, Ultra Hot slot game, bet type as (\\d+), bet value as FIFTY, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_bet_type_as_bet_value_as_FIFTY_balance_and_spin_button(int arg1) throws Throwable {

		this.driver = UltraHot_URL_Login.getDriver();
	}

	@When("^Open the Ultra Hot slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+) & bet value as FIFTY, click on spin button and check the balance$")
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_bet_value_as_FIFTY_click_on_spin_button_and_check_the_balance(int arg1) throws Throwable {
	...
	@Then("^Balance should get deducted by FIFTY, as bet type is selected as (\\d+) in Ultra Hot game$")
	public void balance_should_get_deducted_by_FIFTY_as_bet_type_is_selected_as_in_Ultra_Hot_game(int arg1) throws Throwable {
