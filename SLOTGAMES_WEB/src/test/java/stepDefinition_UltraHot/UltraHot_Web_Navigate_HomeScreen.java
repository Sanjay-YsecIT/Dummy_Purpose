...
public class UltraHot_Web_Navigate_HomeScreen {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button() throws Throwable {
		...
		Pattern Home_Screen_Logo=new Pattern("./Images/Ultra_Hot/suribet_logo.PNG");
		Pattern Ultra_Hot=new Pattern("./Images/Ultra_Hot/UltraHot_logo.PNG");
		Pattern home=new Pattern("./Images/Ultra_Hot/home.PNG");

		//Comparing whether Ultra Hot  game is loaded and home button is visible
		// Pattern credit1=new Pattern("E:/Sikuli Images/others/goldenhot.png");
		Finder finder =new Finder(screen.capture().getImage());
		String ht = finder.find(Ultra_Hot);
		double score=20;                
		...
		if(finder.hasNext())
		{
			...
			System.out.println("Ultra Hot game is loaded and comparision successfull.");
			finder.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Ultra Hot is loaded and comparision value equals to: "+" "+score +"%");
		...
		//After clicking on home button, Ultra Hot game should not be visible
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Navigate to the home screen & Ultra Hot home page should not be visible and comparision successfull.");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Navigate to the home screen of the Ultra Hot slot games and comparision value is equal to: "+" "+score2 +"%");
