...
public class UltraHot_Web_Balance_Credits_Calculations_3 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_and_compare_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern creditValue=new Pattern("./Images/Ultra_Hot/credit_0.1.PNG");
		Pattern Credit_bal=new Pattern("./Images/Ultra_Hot/cr_bal_3000.PNG");
	...
	@Then("^Balance amount should be same as denomination (\\d+)\\.(\\d+) multiplies by credit balance in Ultra Hot slot game$")
	public void balance_amount_should_be_same_as_denomination_multiplies_by_credit_balance_in_Ultra_Hot_slot_game(int arg1, int arg2) throws Throwable {
