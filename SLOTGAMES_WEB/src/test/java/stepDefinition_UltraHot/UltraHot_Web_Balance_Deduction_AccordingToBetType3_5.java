...
public class UltraHot_Web_Balance_Deduction_AccordingToBetType3_5 {
	...
	@Given("^Chrome browser, valid URL, valid login details, Ultra Hot slot game, bet type as (\\d+)\\.(\\d+) from drop down, bet value as (\\d+), balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_bet_type_as_from_drop_down_bet_value_as_balance_and_spin_button(int arg1, int arg2, int arg3) throws Throwable {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_TEN_from_bet_type_drop_down_click_on_spin_button_and_check_the_balance() throws Throwable {
