...
public class UltraHot_Web_TryNow_Spin_Deduct_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/ui-view[1]/section[1]/section[1]/div[1]/div[1]/div[2]/div[3]/ul[1]/li[34]/div[2]/div[2]")).click();
		screen.wait("./Images/Ultra_Hot/GlowingHot_logo.PNG", 10);
		//	Thread.sleep(15000);
	}

	@When("^Open the Ultra Hot slot game by entering the valid URL in browser, click on try now button and click on spin button$")
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {
	   
		Pattern Trynow_bal=new Pattern("./Images/Ultra_Hot/Try_now_bal.PNG");
		Pattern BalAfterSpin=new Pattern("./Images/Ultra_Hot/TN_BalAfterspin.PNG");
		Pattern Spin=new Pattern("./Images/Ultra_Hot/TN_Spin.PNG");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Ultra_Hot_slot_game() throws Throwable {
