...
public class GlowingHot_Web_Balance_Deduction_AccordingToBetType3_5 {
	...
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_TEN_from_bet_type_drop_down_click_on_spin_button_and_check_the_balance() throws Throwable {
	...
	@Then("^Balance should get deducted by TEN, if bet type is selected as (\\d+)\\.(\\d+) & bet value as TEN, in Glowing Hot slot game$")
	public void balance_should_get_deducted_by_TEN_if_bet_type_is_selected_as_bet_value_as_TEN_in_Glowing_Hot_slot_game(int arg1, int arg2) throws Throwable {
