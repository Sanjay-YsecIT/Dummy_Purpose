...
public class GlowingHot_Web_AutoSpin_AutoSpinOption {
	...
	public void chrome_browser_valid_URL_valid_login_details_Glowing_Hot_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Glowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_the_player_instruction_message() throws Throwable {
		...
		screen.wait("./Images/Glowing_Hot/Bet_place.PNG", 10);
		//	Thread.sleep(15000);
		
		Pattern autospin=new Pattern("./Images/Glowing_Hot/autospin.PNG");
		Pattern credit1=new Pattern("./Images/Glowing_Hot/goodluck.PNG");
		Pattern pat=new Pattern("./Images/Glowing_Hot/goodluck.PNG");
	...
	public void system_should_keep_performing_the_spins_in_Glowing_Hot_slot_game() throws Throwable {
	   
		Pattern autospin_cancel=new Pattern("./Images/Glowing_Hot/autospin.PNG");
