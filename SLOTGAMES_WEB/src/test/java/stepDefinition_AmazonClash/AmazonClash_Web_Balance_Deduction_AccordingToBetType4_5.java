...
public class AmazonClash_Web_Balance_Deduction_AccordingToBetType4_5 {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Amazon Clash slot game, bet type as (\\d+)\\.(\\d+), bet value as two hundred, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Amazon_Clash_slot_game_bet_type_as_bet_value_as_two_hundred_balance_and_spin_button(int arg1, int arg2) throws Throwable {

		this.driver = AmazonClash_URL_Login.getDriver();
	}

	@When("^Open the Amazon Clash slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+) & bet value as two hundred, click on spin button and check the balance$")
	public void open_the_Amazon_Clash_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_bet_value_as_two_hundred_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
	...
	public void balance_should_get_deducted_by_two_hundred_as_bet_type_is_selected_as_in_Amazon_Clash_game(int arg1, int arg2) throws Throwable {
