...
public class AmazonClash_Web_Balance_Credits_Calculations_3 {
	...
	public void open_the_Amazon_Clash_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_and_compare_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern creditValue=new Pattern("Images/Amazon_Clash/credit_0.05.PNG");
		Pattern Credit_bal=new Pattern("Images/Amazon_Clash/cr_bal_6000.PNG");
	...
	@Then("^Balance amount should be same as denomination (\\d+)\\.(\\d+) multiplies by credit balance in Amazon Clash slot game$")
	public void balance_amount_should_be_same_as_denomination_multiplies_by_credit_balance_in_Amazon_Clash_slot_game(int arg1, int arg2) throws Throwable {
