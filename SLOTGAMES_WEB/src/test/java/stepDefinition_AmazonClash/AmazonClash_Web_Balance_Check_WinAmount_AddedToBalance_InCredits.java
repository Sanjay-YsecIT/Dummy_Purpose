...
public class AmazonClash_Web_Balance_Check_WinAmount_AddedToBalance_InCredits {
	...
	public void chrome_browser_valid_URL_valid_login_details_Amazon_Clash_slot_game_balance_transfer_button_credit_balance_form_spin_button_and_win_amount() throws Throwable {
	...
	public void open_the_Amazon_Clash_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_balance_window_to_change_to_credit_form_click_on_spin_button_till_user_win_and_check_the_balance_after_win_in_credits() throws Throwable {
		...
		Pattern cr_bet=new Pattern("Images/Amazon_Clash/cr_bet1.PNG");
		Pattern betval=new Pattern("Images/Amazon_Clash/cr_betval1_1.PNG");
		Pattern spin=new Pattern("Images/Amazon_Clash/spin.PNG");
		Pattern win_amt = new Pattern("Images/Amazon_Clash/cr_winamt.PNG");
		Pattern collect=new Pattern("Images/Amazon_Clash/collect.PNG");
		Pattern balance=new Pattern("Images/Amazon_Clash/bal_300.PNG");
		Pattern cr_balance=new Pattern("Images/Amazon_Clash/cr_bal.PNG");
		Pattern cr_deductbal=new Pattern("Images/Amazon_Clash/cr_deductbal.PNG");
		Pattern cr_winbal=new Pattern("Images/Amazon_Clash/cr_winbal.PNG");
