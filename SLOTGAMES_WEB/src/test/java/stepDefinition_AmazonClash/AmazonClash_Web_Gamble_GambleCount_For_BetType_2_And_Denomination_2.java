...
public class AmazonClash_Web_Gamble_GambleCount_For_BetType_2_And_Denomination_2 {
	...
	public void open_the_Amazon_Clash_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_transfer_the_balance_click_on_Amazon_Clash_slot_game_transfer_amount_to_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		Pattern WIN_AMT1=new Pattern("./Images/Amazon_Clash/win_1.6.PNG");    
		Pattern WIN_AMT2=new Pattern("./Images/Amazon_Clash/win_2.4.PNG");    
		Pattern WIN_AMT3=new Pattern("./Images/Amazon_Clash/win_5.2.PNG");   
		Pattern WIN_AMT4=new Pattern("./Images/Amazon_Clash/win_7.2.PNG");    
		Pattern WIN_AMT5=new Pattern("./Images/Amazon_Clash/win_16.4.PNG");    
		Pattern WIN_AMT6=new Pattern("./Images/Amazon_Clash/win_28.PNG");    
