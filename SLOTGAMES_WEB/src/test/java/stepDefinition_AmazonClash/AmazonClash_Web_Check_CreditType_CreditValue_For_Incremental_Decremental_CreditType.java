...
public class AmazonClash_Web_Check_CreditType_CreditValue_For_Incremental_Decremental_CreditType {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Amazon Clash slot game, credit type as (\\d+)\\.(\\d+), (\\d+)\\.(\\d+), (\\d+)\\.(\\d+), (\\d+)\\.(\\d+)  and credit balance generated respectively to credit types$")
	public void chrome_browser_valid_URL_valid_login_details_Amazon_Clash_slot_game_credit_type_as_and_credit_balance_generated_respectively_to_credit_types(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) throws Throwable {
		this.driver = AmazonClash_URL_Login.getDriver();
	}

	@When("^Open the Amazon Clash slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+) and increment and decrement the credit types and check the credit balance respectively$")
	public void open_the_Amazon_Clash_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_and_increment_and_decrement_the_credit_types_and_check_the_credit_balance_respectively(int arg1, int arg2) throws Throwable {
		...
		Pattern credit2=new Pattern("Images/Amazon_Clash/credit_0.02.PNG");
		Pattern credit3=new Pattern("Images/Amazon_Clash/credit_0.05.PNG");
		Pattern credit4=new Pattern("Images/Amazon_Clash/credit_0.5.PNG");
		Pattern balance=new Pattern("Images/Amazon_Clash/bal_300.PNG");
		Pattern cr_bal1=new Pattern("Images/Amazon_Clash/cr_bal.PNG");
		Pattern cr_bal2=new Pattern("Images/Amazon_Clash/cr_bal_15000.PNG");
		Pattern cr_bal3=new Pattern("Images/Amazon_Clash/cr_bal_6000.PNG");
		Pattern cr_bal4=new Pattern("Images/Amazon_Clash/cr_bal_600.PNG");
		Pattern cr_inc=new Pattern("Images/Amazon_Clash/cr_inc.PNG");
	...
	public void credit_balance_value_should_get_changed_according_to_credit_type_from_the_drop_down_in_Amazon_Clash_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
