...
public class SkinfiriMysterious_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2 {
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysteriousslot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_two() throws Throwable {
	...
	public void open_the_Skinfiri_Mysteriousslot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_two_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
...
//		File DestSrc = new File("./ScreenShots/scrsht/Web_Balance_To_Credits_0.02.png");
//		FileUtils.copyFile(sct, DestSrc);
		...
		Pattern WIN_AMT=new Pattern("./Images/Skinfiri_Mysterious/WIN_AMT_0.02.PNG");
		Pattern BALANCE=new Pattern("./Images/Skinfiri_Mysterious/BAL_AFTER_SPIN.PNG");
		Pattern BALANCE_CR=new Pattern("./Images/Skinfiri_Mysterious/BAL_IN_CR_AFTER_SPIN_0.02.PNG");
		Pattern WIN_CR=new Pattern("./Images/Skinfiri_Mysterious/WIN_AMT_INCR_40.PNG");
		
		
		
		// to change from 0.01 to 0.02cr
	...
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_two_is_equal_to_win_amount_in_currency_in_Skinfiri_Mysteriousslot_game() throws Throwable {
