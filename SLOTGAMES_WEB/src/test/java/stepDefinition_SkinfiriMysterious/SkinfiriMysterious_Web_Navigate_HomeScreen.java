...
//		File DestSrc = new File("./ScreenShots/scrsht/HomeScreen.png");
//		FileUtils.copyFile(sct, DestSrc);
//		Thread.sleep(15000);
		
		
		Pattern Skinfiri_Mysterious=new Pattern("./Images/Skinfiri_Mysterious/Skinfiri_Mysterious_label.PNG");
		Pattern home=new Pattern("./Images/Skinfiri_Mysterious/home_icon.PNG");
		Pattern Home_Screen_Logo=new Pattern("./Images/Skinfiri_Mysterious/SM_logo.PNG");
	     ...
	     // Pattern winA=new Pattern("E:/Sikuli Images/others/goldenhot.PNG");
		  ...
		  System.out.println("Navigate to the home screen & Skinfiri Mysterious home page should not be visible and comparision successfull.");
		  finder2.destroy();  
		  }         
		  else    
		  { 
