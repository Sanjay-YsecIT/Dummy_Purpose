...
public class SkinfiriMysterious_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysterious_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_scatter_wild_gamble_freespin_and_jackpot_window() throws Throwable {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/Emerald_Dice/arrow_forward.PNG");
		Pattern backward=new Pattern("./Images/Emerald_Dice/arrow_reverse.PNG");
		Pattern exit=new Pattern("./Images/Emerald_Dice/exit_image.PNG");
		Pattern payout=new Pattern("./Images/Emerald_Dice/payout_info.PNG");
		...
		Pattern freespin=new Pattern("./Images/Emerald_Dice/freespin_info.PNG");
...
//		click on forward icon available on the info page to move to free spin window
		screen.click(forward);
		Thread.sleep(1000);
...
//		validation on exit button, once its clicked it has move to game window
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Skinfiri_Mysterious_slot_game() throws Throwable {
