...
public class SkinfiriMysterious_Web_AutoSpin_TwentySpins {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_twenty_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern autospin_20=new Pattern("Images/Skinfiri_Mysterious/20spin.PNG");  
		Pattern pat2=new Pattern("Images/Skinfiri_Mysterious/19spin_left.PNG"); 
		Pattern pat3=new Pattern("Images/Skinfiri_Mysterious/17spin_left.PNG");               
		Pattern pat4=new Pattern("Images/Skinfiri_Mysterious/15spin_left.PNG");               
		Pattern pat5=new Pattern("Images/Skinfiri_Mysterious/13spin_left.PNG");              
		Pattern pat6=new Pattern("Images/Skinfiri_Mysterious/11spin_left.PNG");              
		Pattern pat7=new Pattern("Images/Skinfiri_Mysterious/9spin_left.PNG");			  
		Pattern pat8=new Pattern("Images/Skinfiri_Mysterious/7spin_left.PNG");			              
		Pattern pat10=new Pattern("Images/Skinfiri_Mysterious/2spin_left.PNG");             
