...
public class SkinfiriMysterious_Web_PayOut_BetType_05_And_Denomination_All {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_bell_lemon_n_etc_click_on_back_button_select_bet_type_as_denomination_values_like_and_check_payout_amount_on_web(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
		...
		Pattern deno1=new Pattern("./Images/Skinfiri_Mysterious/deno_10.PNG");
		Pattern deno2=new Pattern("./Images/Skinfiri_Mysterious/deno_20.PNG");
		Pattern deno3=new Pattern("./Images/Skinfiri_Mysterious/deno_50.PNG");
		Pattern deno4=new Pattern("./Images/Skinfiri_Mysterious/deno_100.PNG");
		Pattern deno5=new Pattern("./Images/Skinfiri_Mysterious/deno_200.PNG");
	...
	@Then("^System should display the Payout max amount on each symbol like bell, lemon n etc and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination values like (\\d+), (\\d+), (\\d+), (\\d+) & (\\d+) in Skinfiri Mysterious slot game on web$")
