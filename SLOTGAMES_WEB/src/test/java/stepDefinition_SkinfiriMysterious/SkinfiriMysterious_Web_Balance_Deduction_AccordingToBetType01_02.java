...
public class SkinfiriMysterious_Web_Balance_Deduction_AccordingToBetType01_02 {
	...
	@When("^Open the Skinfiri Mysterious game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value as (\\d+)\\.(\\d+), click on spin button and check the balance$")
...
//		Thread.sleep(15000);
		...
		Pattern betval=new Pattern("./Images/Skinfiri_Mysterious/deno_0.2.PNG");
