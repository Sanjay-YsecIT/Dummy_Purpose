...
public class SkinfiriMysterious_Web_TryNow_Spin_Deduct_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysterious_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {
	    
		
		Pattern Trynow_bal=new Pattern("./Images/Skinfiri_Mysterious/Try_now_bal.PNG");
		Pattern BalAfterSpin=new Pattern("./Images/Skinfiri_Mysterious/TN_BalAfterspin.PNG");
		Pattern credit_inc=new Pattern("./Images/Skinfiri_Mysterious/TN_credit_inc.PNG");
		Pattern Deno=new Pattern("./Images/Skinfiri_Mysterious/TN_deno_8.PNG");
		Pattern Spin=new Pattern("./Images/Skinfiri_Mysterious/TN_Spin.PNG");
	    ...
	    //  Pattern credit2=new Pattern("E:/Sikuli Images/TreasureBonanza/trybalance1.PNG");
		  ...
		  System.out.println("Balance should be 4992.00 in try now screen and comparision successfull");
		  finder1.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Balance should be 4992.00 in try now screen and comparision value equals to: "+" "+score1 +"%");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Skinfiri_Mysteriousslot_game() throws Throwable {
