...
public class SkinfiriMysterious_Web_Balance_Deduction_AccordingToBetType3_4 {
	...
	@Given("^Chrome browser, valid URL, valid login details, Skinfiri Mysterious slot game, bet type as (\\d+)\\.(\\d+) from drop down, bet value as TEN, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysterious_slot_game_bet_type_as_from_drop_down_bet_value_as_TEN_balance_and_spin_button(int arg1, int arg2) throws Throwable {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_TEN_from_bet_type_drop_down_click_on_spin_button_and_check_the_balance() throws Throwable {
...
//		File DestSrc = new File("./ScreenShots/scrsht/Bet0.5_10.png");
...
//		Thread.sleep(15000);
		...
		Pattern betval=new Pattern("./Images/Skinfiri_Mysterious/betvalue3_4.PNG");
	...
	@Then("^Balance should get deducted by TEN if bet type is selected as (\\d+)\\.(\\d+) & bet value as TEN in Skinfiri Mysterious game$")
	public void balance_should_get_deducted_by_TEN_if_bet_type_is_selected_as_bet_value_as_TEN_in_Skinfiri_Mysterious_game(int arg1, int arg2) throws Throwable {
