...
public class SkinfiriMysterious_Web_Gamble_GambleAmount_DoubleThan_WinAmount {
	...
	public void open_the_Skinfiri_Mysteriousgame_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Skinfiri_Mysterious_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
		...
		Pattern COLOUR_WIN=new Pattern("Images/Skinfiri_Mysterious/gamble_win_amt_0.8.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Color Win amount comparision completed successfully. Gamble Win amount is 0.8 YSI");
			finder3.destroy();  
		}         
		else    
		{ 
