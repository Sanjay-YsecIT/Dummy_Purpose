...
public class SkinfiriMysterious_Web_Gamble_GambleAmount_DoubleThan_WinAmount {
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysterious_game_balance_spin_button_win_amount_gamble_button_gamble_amount_and_gamble_to_win_amount() throws Throwable {
	   
		this.driver = SkinfiriMysterious_URL_Login.getDriver();
		
	}

	@When("^Open the Skinfiri Mysteriousgame by entering the valid URL in browser, enter the valid login details, transfer the balance, click on golden hot slot game, click on spin button till player wins, click on gamble button and check the gamble to win amount$")
	public void open_the_Skinfiri_Mysteriousgame_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
...
//		File DestSrc = new File("./ScreenShots/scrsht/gamble_windouble_before.png");
...
//		Thread.sleep(15000);
		...
		Pattern COLOUR_WIN=new Pattern("./Images/Skinfiri_Mysterious/gamble_win_amt_16ysi.PNG");
		...
		// WIN PATTERN COMBINATION 
		   ...
		   //   Pattern winB=new Pattern("E:/Sikuli Images/gamble/Colorwin.PNG");
		      ...
		      String ht3 = finder3.find(COLOUR_WIN);
		      double score3=20;                
