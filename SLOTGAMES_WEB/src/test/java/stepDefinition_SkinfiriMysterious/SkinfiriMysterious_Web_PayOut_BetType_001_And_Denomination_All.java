...
public class SkinfiriMysterious_Web_PayOut_BetType_001_And_Denomination_All {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_click_on_back_button_select_bet_type_as_all_denomination_values_and_check_payout_amount(int arg1, int arg2) throws Throwable {
		...
		Pattern deno1=new Pattern("./Images/Skinfiri_Mysterious/deno_0.2.PNG");
		Pattern deno2=new Pattern("./Images/Skinfiri_Mysterious/deno_0.4.PNG");
		Pattern deno3=new Pattern("./Images/Skinfiri_Mysterious/deno_1.PNG");
		Pattern deno4=new Pattern("./Images/Skinfiri_Mysterious/deno_2.PNG");
		Pattern deno5=new Pattern("./Images/Skinfiri_Mysterious/deno_4.PNG");

		Pattern pat1=new Pattern("./Images/Skinfiri_Mysterious/PO01_0.2.PNG");
		Pattern pat2=new Pattern("./Images/Skinfiri_Mysterious/PO01_0.4.PNG");
		Pattern pat3=new Pattern("./Images/Skinfiri_Mysterious/PO01_1.PNG");
		Pattern pat4=new Pattern("./Images/Skinfiri_Mysterious/PO01_2.PNG");
		Pattern pat5=new Pattern("./Images/Skinfiri_Mysterious/PO01_4.PNG");
		...
		//Selecting the denomination as 0.02
		screen.click(deno1);
		Thread.sleep(2000);
	...
	@Then("^System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination values in Skinfiri Mysterious slot game on Web$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_values_in_Skinfiri_Mysterious_slot_game_on_Web(int arg1, int arg2) throws Throwable {
