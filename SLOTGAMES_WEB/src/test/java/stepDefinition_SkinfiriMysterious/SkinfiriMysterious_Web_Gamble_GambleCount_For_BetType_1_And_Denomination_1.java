...
public class SkinfiriMysterious_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_1 {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Skinfiri_Mysterious_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_user_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		Pattern WIN_AMT1=new Pattern("Images/Skinfiri_Mysterious/win1_0.35.PNG");    
		Pattern WIN_AMT2=new Pattern("Images/Skinfiri_Mysterious/win2_0.6.PNG");   
		Pattern WIN_AMT3=new Pattern("Images/Skinfiri_Mysterious/win3_1.PNG");    
		Pattern WIN_AMT4=new Pattern("Images/Skinfiri_Mysterious/win4_2.PNG");    
		Pattern WIN_AMT5=new Pattern("Images/Skinfiri_Mysterious/win5_5.PNG");    
		Pattern WIN_AMT6=new Pattern("Images/Skinfiri_Mysterious/win_24.PNG");  
