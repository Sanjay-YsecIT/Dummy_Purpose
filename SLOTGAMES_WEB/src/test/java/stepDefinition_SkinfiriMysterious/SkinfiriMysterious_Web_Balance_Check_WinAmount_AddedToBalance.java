...
public class SkinfiriMysterious_Web_Balance_Check_WinAmount_AddedToBalance {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_spin_button_till_user_win_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern BalanceAfter=new Pattern("Images/Skinfiri_Mysterious/bal_300.20.PNG");
...
//		screen.wait(credit1.exact(),3000);
//		screen.wait(credit1.similar((float) 0.97),3000);
//		System.out.println(screen.wait(credit1.getSimilar(),3000));
		double score=20;                
		...
		String ht3 = finder3.find(BalanceAfter);
		double score3=20;                
		...
		//comparing the Winning CROSS symbols animation
	...
	public void win_amount_should_get_deposited_to_the_balance_after_win_and_balance_should_get_increased_with_win_amount() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
