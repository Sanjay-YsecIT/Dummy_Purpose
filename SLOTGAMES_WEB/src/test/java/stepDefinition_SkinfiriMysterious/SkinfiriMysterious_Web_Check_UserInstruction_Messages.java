...
public class SkinfiriMysterious_Web_Check_UserInstruction_Messages {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_and_check_the_user_instruction_messages() throws Throwable {
		...
		Pattern Good_Luck = new Pattern("Images/Skinfiri_Mysterious/goodLuck.PNG");
		Pattern Bet_Place = new Pattern("Images/Skinfiri_Mysterious/Bet_place.PNG");
