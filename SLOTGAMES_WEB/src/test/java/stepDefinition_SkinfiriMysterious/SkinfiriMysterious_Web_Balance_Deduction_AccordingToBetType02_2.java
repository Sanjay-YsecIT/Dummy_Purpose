...
public class SkinfiriMysterious_Web_Balance_Deduction_AccordingToBetType02_2 {
	...
	@When("^Open the Skinfiri Mysteriousslot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value as TWO, click on spin button and check the win amount and balance$")
	public void open_the_Skinfiri_Mysteriousslot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_select_the_bet_value_as_TWO_click_on_spin_button_and_check_the_win_amount_and_balance(int arg1, int arg2) throws Throwable {
