...
public class SkinfiriMysterious_Web_Gamble_GambleCount_For_BetType_002_And_Denomination_08 {
	...
	//	Pattern BALANCE=new Pattern("./Images/Skinfiri_Mysterious/bal_300.PNG");                   // BAL AT INITIAL STAGE
		...
		Pattern DENO_8=new Pattern("./Images/Skinfiri_Mysterious/deno_0.8.PNG");                      // DENOMINATION OF 0.01
	...
	//	Pattern CREDIT = new Pattern("./Images/Skinfiri_Mysterious/0.02_credit.PNG");
		...
		//Arranging the symbols to generate gamble count as 5
				...
				//Arranging the symbols to generate win amount more than  and checking gamble link should be disabled
