...
public class SkinfiriMysterious_Web_AutoSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Mysterious_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Skinfiri_Mysterious_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern pat1=new Pattern("Images/Skinfiri_Mysterious/autoplay_stop.PNG");
		Pattern auto=new Pattern("Images/Skinfiri_Mysterious/auto.PNG");
		Pattern ahome=new Pattern("Images/Skinfiri_Mysterious/autoplay_home.PNG");
		Pattern ainfo=new Pattern("Images/Skinfiri_Mysterious/autoplay_info.PNG");
		Pattern acreditvalue=new Pattern("Images/Skinfiri_Mysterious/autoplay_credit.PNG");
		Pattern abetvalue=new Pattern("Images/Skinfiri_Mysterious/autoplay_betvalue.PNG");
		Pattern astop=new Pattern("Images/Skinfiri_Mysterious/spin_stop.PNG");
		Pattern bet_inc=new Pattern("Images/Skinfiri_Mysterious/autoplay_betvalue_click.PNG");
		Pattern credit_inc=new Pattern("Images/Skinfiri_Mysterious/autoplay_creditvalue_click.PNG");
		Pattern bet=new Pattern("Images/Skinfiri_Mysterious/bet1.PNG");
		Pattern credit1=new Pattern("Images/Skinfiri_Mysterious/credit1.PNG");
		Pattern payout1_1=new Pattern("Images/Skinfiri_Mysterious/PO01_0.2.PNG");
		Pattern goodluck=new Pattern("Images/Skinfiri_Mysterious/goodLuck.PNG");
		Pattern placebet=new Pattern("Images/Skinfiri_Mysterious/placebet.PNG");
		...
		if(finder22.hasNext())
		{
			...
			System.out.println("Testcase1: Good luck message is displayed during autoplay. Test case passed");
			finder22.destroy();  
		}         
		else    
		{ 
