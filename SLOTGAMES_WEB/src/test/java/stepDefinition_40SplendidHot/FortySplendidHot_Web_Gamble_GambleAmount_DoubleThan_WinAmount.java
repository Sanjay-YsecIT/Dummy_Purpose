...
public class FortySplendidHot_Web_Gamble_GambleAmount_DoubleThan_WinAmount {
	...
	public void chrome_browser_valid_URL_valid_login_details_FortySplendidHot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_and_gamble_to_win_amount() throws Throwable {
	...
	public void open_the_FortySplendidHot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_FortySplendidHot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
		...
		Pattern gb_colorwin_amt=new Pattern("Images/40Splendid_Hot/gb_colorwin.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Gamble Win amount comparision completed successfully. Gamble Win amount is 1.40 YSI");
			finder3.destroy();  
		}         
		else    
		{ 
	...
	public void gamble_To_Win_amount_should_be_double_than_Gamble_amount_in_the_gamble_page_of_the_FortySplendidHot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
