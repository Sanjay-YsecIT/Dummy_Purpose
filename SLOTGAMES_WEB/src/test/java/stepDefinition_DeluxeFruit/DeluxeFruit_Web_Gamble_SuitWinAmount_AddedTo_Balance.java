...
public class DeluxeFruit_Web_Gamble_SuitWinAmount_AddedTo_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruit_slot_game_balance_spin_button_win_amount_gamble_button_card_to_click_for_suit_win_and_suit_win_amount() throws Throwable {
	...
	public void open_the_Deluxe_Fruit_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_click_on_suit_win_card_in_gamble_page() throws Throwable {
		...
		Pattern suit_heart=new Pattern("./Images/Deluxe_Fruit/suit_heart.PNG");
		Pattern gb_win=new Pattern("./Images/Deluxe_Fruit/gb_win.PNG");
		Pattern gb_lose=new Pattern("./Images/Deluxe_Fruit/gb_loose.PNG");
		Pattern win_bal=new Pattern("./Images/Deluxe_Fruit/suit_winamt_add.PNG");
	...
	@Then("^Suit Win amount\\((\\d+)X\\) should get added to the main balance after win else it should not get added to main balance in the Deluxe Fruit slot game$")
	public void suit_Win_amount_X_should_get_added_to_the_main_balance_after_win_else_it_should_not_get_added_to_main_balance_in_the_Deluxe_Fruit_slot_game(int arg1) throws Throwable {
