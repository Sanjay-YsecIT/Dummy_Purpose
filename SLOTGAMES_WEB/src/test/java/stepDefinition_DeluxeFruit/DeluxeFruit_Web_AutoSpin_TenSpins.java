...
public class DeluxeFruit_Web_AutoSpin_TenSpins {
	...
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruit_slot_game_balance_spin_button_auto_spin_button_ten_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Deluxe_Fruit_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_ten_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern autospin_10=new Pattern("./Images/Deluxe_Fruit/10spin.PNG");

		Pattern pat2=new Pattern("./Images/Deluxe_Fruit/9spin_left.PNG");
		Pattern pat3=new Pattern("./Images/Deluxe_Fruit/8spin_left.PNG");
		Pattern pat4=new Pattern("./Images/Deluxe_Fruit/7spin_left.PNG");
		Pattern pat5=new Pattern("./Images/Deluxe_Fruit/6spin_left.PNG");
		Pattern pat6=new Pattern("./Images/Deluxe_Fruit/5spin_left.PNG");
		Pattern pat7=new Pattern("./Images/Deluxe_Fruit/4spin_left.PNG");
		Pattern pat8=new Pattern("./Images/Deluxe_Fruit/3spin_left.PNG");
		Pattern pat9=new Pattern("./Images/Deluxe_Fruit/2spin_left.PNG");
		Pattern pat10=new Pattern("./Images/Deluxe_Fruit/1spin_left.PNG");
		Pattern pat11=new Pattern("./Images/Deluxe_Fruit/last_spin.PNG");
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking ten spins option and should perform (\\d+) spins from (\\d+) to (\\d+) Deluxe Fruit slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_ten_spins_option_and_should_perform_spins_from_to_Deluxe_Fruit_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
