...
public class DeluxeFruit_Web_Gamble_SuitWinAmount_quadrupleThan_WinAmount {
	...
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruit_game_balance_spin_button_win_amount_Suit_win_dice_options_gamble_amount_and_suit_to_win_amount() throws Throwable {
	...
	public void open_the_Deluxe_Fruit_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Deluxe_Fruit_slot_game_click_on_spin_button_till_player_wins_click_on_suit_win_dice_button_and_check_the_suit_to_win_amount() throws Throwable {
		...
		Pattern gb_suitwin_amt=new Pattern("./Images/Deluxe_Fruit/suit_winamt_display.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Gamble Suit Win amount comparision completed successfully. Gamble Suit Win amount is 0.20 YSI");
			finder3.destroy();  
		}         
		else    
		{ 
	...
	public void suit_To_Win_amount_should_be_quadraple_than_win_amount_in_the_gamble_page_of_the_Deluxe_Fruit_game() throws Throwable {
