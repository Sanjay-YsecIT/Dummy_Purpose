...
public class DeluxeFruit_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruit_slot_game_balance_info_icon_navigation_icon_exit_icon_payout_paylines_wild_scatter_wheelspin_freespin_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Deluxe_Fruit_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern info=new Pattern("./Images/Deluxe_Fruit/info_icon.PNG");
		Pattern forward=new Pattern("./Images/Deluxe_Fruit/forward.PNG");
		Pattern backward=new Pattern("./Images/Deluxe_Fruit/backward.PNG");
		Pattern exit=new Pattern("./Images/Deluxe_Fruit/exit.PNG");
		Pattern payout=new Pattern("./Images/Deluxe_Fruit/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/Deluxe_Fruit/paylines_info.PNG");
		Pattern wild=new Pattern("./Images/Deluxe_Fruit/wild_info.PNG");
		Pattern scatter=new Pattern("./Images/Deluxe_Fruit/scatter_info.PNG");
		Pattern wheelspin=new Pattern("./Images/Deluxe_Fruit/wheelspin_info.PNG");
		Pattern freespin=new Pattern("./Images/Deluxe_Fruit/freespin_info.PNG");
		Pattern gamble=new Pattern("./Images/Deluxe_Fruit/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/Deluxe_Fruit/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/Deluxe_Fruit/game_window.PNG");
		...
		//	click on forward icon available on the info page to move to wheelspin window
		screen.click(forward);
		Thread.sleep(1000);

		Finder finder4 =new Finder(screen.capture().getImage());
		String ht4 = finder4.find(wheelspin);
		double score4=20;                
		...
		if(finder4.hasNext())
		{
			...
			System.out.println("info page is at the wheelspin window");
			finder4.destroy();  
		}         
		else    
		{ 
		...
		//	click on backward icon available on the info page to move to wheelspin window
		screen.click(backward);
		Thread.sleep(1000);

		Finder finder71 =new Finder(screen.capture().getImage());
		String ht71 = finder71.find(wheelspin);
		double score71=20;                
		System.out.println("the value of ht"+" "+ht71);
		if(finder71.hasNext())
		{
		...
		System.out.println("Comparision value equals to: "+" "+score71 +"%");
		Assert.assertTrue(score71 > 90);
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Deluxe_Fruit_slot_game() throws Throwable {
