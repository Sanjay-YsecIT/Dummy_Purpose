...
public class DeluxeFruit_Web_AutoSpin_TwentySpins {
	...
	public void chrome_browser_valid_URL_valid_login_details_Deluxe_Fruit_slot_game_balance_spin_button_auto_spin_button_twenty_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Deluxe_Fruit_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_twenty_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern autoicon=new Pattern("./Images/Deluxe_Fruit/autoplay.PNG");
		Pattern autospin_20=new Pattern("./Images/Deluxe_Fruit/20spin.PNG");  // Autospin 20 icon image

		Pattern pat2=new Pattern("./Images/Deluxe_Fruit/19spin_left.PNG"); // 19 spins left image
		Pattern pat3=new Pattern("./Images/Deluxe_Fruit/17spin_left.PNG"); // 17 spins left image
		Pattern pat4=new Pattern("./Images/Deluxe_Fruit/15spin_left.PNG"); // 15 spins left image
		Pattern pat5=new Pattern("./Images/Deluxe_Fruit/13spin_left.PNG"); // 13 spins left image
		Pattern pat6=new Pattern("./Images/Deluxe_Fruit/11spin_left.PNG"); // 11 spins left image
		Pattern pat7=new Pattern("./Images/Deluxe_Fruit/9spin_left.PNG");  // 9 spins left image
		Pattern pat8=new Pattern("./Images/Deluxe_Fruit/7spin_left.PNG");  // 7 spins left image
		//	Pattern pat9=new Pattern("./Images/10Spins/2spin_left.PNG");    // 4 spins left image
		Pattern pat10=new Pattern("./Images/Deluxe_Fruit/2spin_left.PNG"); // 2 spins left image
		Pattern pat11=new Pattern("./Images/Deluxe_Fruit/last_spin.PNG");  // Last Spin image
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking twenty spins option and should perform (\\d+) spins from (\\d+) to (\\d+) in Deluxe Fruit slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_twenty_spins_option_and_should_perform_spins_from_to_in_Deluxe_Fruit_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
