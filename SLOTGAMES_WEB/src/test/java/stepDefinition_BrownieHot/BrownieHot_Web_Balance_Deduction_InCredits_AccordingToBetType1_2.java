...
public class BrownieHot_Web_Balance_Deduction_InCredits_AccordingToBetType1_2 {
	WebDriver driver;
	...
	@When("^Open the Brownie Hot slot game by entering the valid URL in browser, enter the valid login details, select the bet type as (\\d+)\\.(\\d+), select the bet value as (\\d+), click on spin button and check the balance in credits$")
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_select_the_bet_value_as_click_on_spin_button_and_check_the_balance_in_credits(int arg1, int arg2, int arg3) throws Throwable {
		...
		Pattern betval=new Pattern("Images/Brownie_Hot/crbet1_2.PNG");
		Pattern bet1 = new Pattern("Images/Brownie_Hot/crbet1.PNG");
		Pattern spin=new Pattern("Images/Brownie_Hot/spin.PNG");
		Pattern Afterspin_bal=new Pattern("Images/Brownie_Hot/crbalance1_2.PNG");
	...
	@Then("^Balance should get deducted by SIXTY as bet type is selected as (\\d+)\\.(\\d+) and bet value as SIXTY in Brownie Hot game$")
	public void balance_should_get_deducted_by_SIXTY_as_bet_type_is_selected_as_and_bet_value_as_SIXTY_in_Brownie_Hot_game(int arg1, int arg2) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
