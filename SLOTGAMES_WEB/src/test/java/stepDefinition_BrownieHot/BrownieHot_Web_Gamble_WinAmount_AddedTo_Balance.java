...
public class BrownieHot_Web_Gamble_WinAmount_AddedTo_Balance {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Brownie Hot game, balance, spin button, win amount, gamble button, gamble amount, red button, black button and gamble status$")
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_button_and_check_the_balance_after_win_in_win_field() throws Throwable {
		...
		Pattern balance_gamble_win=new Pattern("Images/Brownie_Hot/balance_gamble_win.PNG");
		...
		Pattern pre_gambleamount=new Pattern("/Images/Brownie_Hot/gambleamount.PNG");
		...
		//Gamble count for the win amount
		Finder finder31 =new Finder(screen.capture().getImage());
		String ht31 = finder31.find(gamblecount5);
		double score31=20;                
		...
		System.out.println("Pre Gamble win comparision: "+" "+score31 +"%");
		...
		if  (screen.exists(win) != null)
		{
			...
			//Gamble count for the 1st gamble win 
			// user is allowed for further attempts to play gamble according to gamble count
			Finder finder32 =new Finder(screen.capture().getImage());
			String ht32 = finder32.find(gamblecount4);
			double score32=20;                
			System.out.println("the value of ht3"+" "+ht32);
			if(finder32.hasNext())
			{
			...
			System.out.println("Pre Gamble win comparision: "+" "+score32 +"%");
		...
		String ht19 = finder19.find(home);
		double score19=20;                
		...
		if(finder19.hasNext())
		{
			...
			System.out.println("home button avaialbility after gamble");
			finder19.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("home button comparision after gamble: "+" "+score19 +"%");
		Assert.assertTrue(score19 > 97);
	}

	@Then("^Gamble Win amount should get added to main balance after status displayed as WIN and gamble page should get closed in Brownie Hot game$")
	public void gamble_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Brownie_Hot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
