...
public class BrownieHot_Web_Gamble_WinAmount_AddedTo_Balance_InCredits {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_in_credits_after_win() throws Throwable {
		...
		Pattern balance_credits_1=new Pattern("Images/Brownie_Hot/balance_credits_1.PNG");
		Pattern credit_deductbal=new Pattern("Images/Brownie_Hot/balance_crdeduct_1.PNG");
		...
		Pattern Crpre_gambleamount=new Pattern("/Images/Brownie_Hot/Crpre_gambleamount.PNG");
		Pattern Crpost_gambleamount=new Pattern("/Images/Brownie_Hot/Crpost_gambleamount.PNG");
		Pattern Crpre_gambletowin=new Pattern("/Images/Brownie_Hot/Crpre_gambletowin.PNG");
		Pattern credit_gamble_winbalance=new Pattern("/Images/Brownie_Hot/credit_gamble_winbalance.PNG");
		Pattern credit_gamble_winfield=new Pattern("/Images/Brownie_Hot/credit_gamble_winfield.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 40 and gamble amount is 40 after 1st win gamble amount is "80"
		...
		else
		{
			...
			if(finder11.hasNext())
			{
				...
				System.out.println("Balance After losing in gamble. Balance is 29,970");
				finder11.destroy();  
			}         
			else    
			{ 
	...
	public void verify_the_credit_form_of_currency_in_gamble_page_on_all_fields_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
