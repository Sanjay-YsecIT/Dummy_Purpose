...
public class BrownieHot_Web_Gamble_WinAmount_SameAs_GambleAmount {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Brownie Hot game, balance, spin button, win amount, gamble button and gamble amount$")
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_game_balance_spin_button_win_amount_gamble_button_and_gamble_amount() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_amount_on_web() throws Throwable {
		...
		Pattern gambleamount=new Pattern("/Images/Brownie_Hot/gambleamount.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Gamble Win amount comparision completed successfully. Gamble Win amount is 0.40 SRD");
			finder3.destroy();  
		}         
		else    
		{ 
	...
	public void win_amount_should_be_displayed_as_Gamble_amount_in_the_gamble_page_of_the_Brownie_Hot_slot_game_on_web() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
