...
public class BrownieHot_Web_Check_MultipleLogin_Messages {
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_spin_Multiple_login_windows_multiple_login_alert_pop_up() throws Throwable {
		this.driver = BrownieHot_URL_Login.getDriver();
	}

	@When("^Open the  slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on slot game, spin the reels and open another session and play the game and return back to older session and play$")
	public void open_the_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_slot_game_spin_the_reels_and_open_another_session_and_play_the_game_and_return_back_to_older_session_and_play() throws Throwable {
		...
		Pattern multiple_login=new Pattern("Images/Brownie_Hot/multiple_login.PNG");
	...
	public void verify_the_Multiple_Login_alert_message_on_the_screen_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Move to new session and play without interruption in Brownie Hot slot game$")
	public void move_to_new_session_and_play_without_interruption_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
