...
public class BrownieHot_Web_Gamble_ResumeFeature_PlayFurtherAttempts_Option {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Brownie Hot slot slot game, bet type, denomination, balance, win symbols, spin button, Gamble screen, new browser\\.$")
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_slot_game_bet_type_denomination_balance_win_symbols_spin_button_Gamble_screen_new_browser() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_win_appears_and_gamble_screen_in_switched_and_click_on_red_button_and_close_the_browser_and_again_login_to_the_game_with_new_browser() throws Throwable {
		...
		Pattern resume_pre_gambleamount=new Pattern("/Images/Brownie_Hot/resume_gambleamount.PNG");
		Pattern resume_post_gambleamount=new Pattern("/Images/Brownie_Hot/resume_post_gambleamount.PNG");
		Pattern resume_pre_gamblecount=new Pattern("/Images/Brownie_Hot/pre_gamblecount.PNG");
		Pattern resume_post_gamblecount=new Pattern("/Images/Brownie_Hot/post_gamblecount.PNG");
		Pattern resume_pre_gamblehistory=new Pattern("/Images/Brownie_Hot/pre_gamblehistory.PNG");
		Pattern resume_post_gamblehistory=new Pattern("/Images/Brownie_Hot/post_gamblehistory.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			if(finder13.hasNext())
			{
				...
				System.out.println("pre gamble attempts left over and comparision completed successfully. Gamble Win amount is 0.40 YSI");
				finder13.destroy();  
			}         
			else    
			{ 
			...
			if(finder14.hasNext())
			{
				...
				System.out.println("post gamble attempts left over after resuming and comparision completed successfully. Gamble Win amount is 0.40 YSI");
				finder14.destroy();  
			}         
			else    
			{ 
	...
	public void resume_feature_should_be_enabled_and_land_on_the_gamble_screen_of_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void verify_the_Gamble_attempts_gamble_amount_gamble_history_and_user_is_able_to_play_left_over_attempts_and_collect_the_win_amount_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
