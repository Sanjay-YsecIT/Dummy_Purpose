...
public class BrownieHot_Web_AutoSpin_InsufficiantBalance_Validation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_balance_AutoSpin_button_validation_message_maxbet_button_credit_decrement_button() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_maxbet_click_on_Autospin_button_till_balance_turns_to_zero_and_check_the_validation_message_and_decrement_the_denomination_and_again_spin_the_reels() throws Throwable {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement TransferInput =	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("transferInput")));
		TransferInput.clear();
		Thread.sleep(1000);
		TransferInput.sendKeys("230");
		Thread.sleep(2000);
		driver.findElement(By.className("Transfer_Ok_but")).click();
		screen.wait("Images/Brownie_Hot/BrownieHot.PNG", 30);

		Pattern autoplay=new Pattern("Images/Brownie_Hot/autoplay.PNG");
		Pattern spin_disable=new Pattern("Images/Brownie_Hot/spin_disable.PNG");
		Pattern disable_bet4_5=new Pattern("Images/Brownie_Hot/disable_bet4_5.PNG");
		Pattern disable_betval=new Pattern("Images/Brownie_Hot/disable_betval.PNG");
		Pattern disable_cr1=new Pattern("Images/Brownie_Hot/cr1.PNG");
		Pattern disable_credit4=new Pattern("Images/Brownie_Hot/disable_credit4.PNG");
		Pattern autolist=new Pattern("Images/Brownie_Hot/autolist.PNG");
		Pattern paylines=new Pattern("Images/Brownie_Hot/paylines.PNG");
		Pattern astop=new Pattern("Images/Brownie_Hot/spin_stop.PNG");
		Pattern autoplay_disable=new Pattern("Images/Brownie_Hot/autoplay_disable.PNG");
		Pattern info_disable=new Pattern("Images/Brownie_Hot/info_disable.PNG");
		Pattern home_disable=new Pattern("Images/Brownie_Hot/home_disable.PNG");
		Pattern turbo_disable=new Pattern("Images/Brownie_Hot/turbo_disable.PNG");
		Pattern paylines_disable=new Pattern("Images/Brownie_Hot/paylines_disable.PNG");
		Pattern maximize_disable=new Pattern("Images/Brownie_Hot/maximize_disable.PNG");
		Pattern hidden_disable=new Pattern("Images/Brownie_Hot/hidden_disable.PNG");
		Pattern creditdec_disable=new Pattern("Images/Brownie_Hot/creditdec_disable.PNG");
		Pattern betdec_disable=new Pattern("Images/Brownie_Hot/betdec_disable.PNG");
		...
		System.out.println("disabled turbo is in off state on screen & Comparision value equals to: "+" "+score11+"%");
		...
		String ht7 = finder7.find(spin_disable);
		double score7=20;                
		...
		System.out.println("betvalues is not present on screen & Comparision value equals to: "+" "+score3 +"%");
		...
		String ht10 = finder10.find(autolist);
		double score10=20;                
		...
		System.out.println("disabled turbo is in off state on screen & Comparision value equals to: "+" "+score10 +"%");
		Assert.assertFalse(score10 > 97);
		...
		String ht13 = finder13.find(hidden_disable);
		double score13=20;                
		...
		if(finder13.hasNext())
		{
			...
			System.out.println("disabled hidden button is clicked and still available on screen during insufficient alert. Test case passed");
			finder13.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("disabled hidden button is clicked and still available on screen & Comparision value equals to: "+" "+score13 +"%");
		...
		String ht14 = finder14.find(paylines);
		double score14=20;                
		...
		System.out.println("disabled hidden button is clicked and still available on screen & Comparision value equals to: "+" "+score14 +"%");
		Assert.assertFalse(score14 > 97);
		...
		String ht18 = finder18.find(spin);
		double score18=20;                
	...
	public void check_for_the_game_buttons_during_the_insufficient_alert_message_in_the_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	}

	@Then("^Player should be blocked from playing the game when there is no balance in the account and after decrementing credit and trigger autospin in Brownie Hot game$")
	public void player_should_be_blocked_from_playing_the_game_when_there_is_no_balance_in_the_account_and_after_decrementing_credit_and_trigger_autospin_in_Brownie_Hot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
