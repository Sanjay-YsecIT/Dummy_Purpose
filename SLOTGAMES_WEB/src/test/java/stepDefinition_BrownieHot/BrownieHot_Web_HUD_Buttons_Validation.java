...
public class BrownieHot_Web_HUD_Buttons_Validation {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Brownie Hot slot game, HUD buttons$")
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_HUD_buttons() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_launch_the_game() throws Throwable {
		...
		Pattern HUD=new Pattern("Images/Brownie_Hot/HUD.PNG");
		Pattern spin=new Pattern("Images/Brownie_Hot/spin.PNG");
		Pattern spin_stop=new Pattern("Images/Brownie_Hot/spin_stop.PNG");
		Pattern turboON=new Pattern("Images/Brownie_Hot/turboON.PNG");
		Pattern turboOFF=new Pattern("Images/Brownie_Hot/turboOFF.PNG");
		Pattern hide=new Pattern("Images/Brownie_Hot/hide.PNG");
		Pattern unhide=new Pattern("Images/Brownie_Hot/unhide.PNG");
		Pattern balance_unhide=new Pattern("Images/Brownie_Hot/balance_unhide.PNG");
