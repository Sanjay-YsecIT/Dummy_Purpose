...
public class BrownieHot_Web_Gamble_ColorWinAmount_AddedTo_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_balance_spin_button_win_amount_gamble_button_gamble_amount_black_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_black_gamble_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern crwin_1 = new Pattern("Images/Brownie_Hot/crwin_1.PNG");            
		...
		Pattern post_gambleamount=new Pattern("/Images/Brownie_Hot/post_gambleamount.PNG");
		...
		String ht2 = finder2.find(crwin_1);
		double score2=20;                
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 0.4 and gamble amount is 0.4 after 1st win gamble amount is "0.80 SRD"
	...
	public void gamble_double_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_terminated_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(2000);
	}

	@Then("^After (\\d+)st win gamble amount is doubled and available for next gamble in Brownie Hot SLot game$")
	public void after_st_win_gamble_amount_is_doubled_and_available_for_next_gamble_in_Brownie_Hot_SLot_game(int arg1) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
