...
public class BrownieHot_Web_AutoSpin_Validations_GamblePage {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page() throws Throwable {
		...
		Pattern balance_afterspin=new Pattern("Images/Brownie_Hot/balance_afterspin.PNG");
		Pattern credit3=new Pattern("Images/Brownie_Hot/credit3.PNG");
		Pattern bet3_5=new Pattern("Images/Brownie_Hot/bet3_5.PNG");
		...
		/*Checking the balance after win & navigating from gamble page
		  ...
		  balance before spin-294
		  win amount is 8 and it is added to main balance after collecting from gamble page hence new bal is 302
		 * 302 is at main balance and after next spin balance is 296 in main balance field
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Balance after win in auto play is 296 and navigating from gamble page & balance comparision completed successfully.");
			finder3.destroy();  
		}         
		else    
		{ 
		...
		if(finder5.hasNext())
		{
			...
			System.out.println("Bet value is 30. Able to increase the bet value after navigating from gamble page. ");
			finder5.destroy();  
		}         
		else    
		{ 
	...
	public void bet_value_Credit_value_buttons_should_be_clickable_after_navigating_from_gamble_page_when_autospin_is_stopped() throws Throwable {
		Thread.sleep(1000);
	}
