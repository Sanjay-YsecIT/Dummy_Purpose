...
public class BrownieHot_Web_ManualSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Brownie_Hot_slot_game_balance_spin_button_spin_button_and_check_for_buttons_behavior_functionality() throws Throwable {
	...
	public void open_the_Brownie_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_option_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern disable_home=new Pattern("Images/Brownie_Hot/disable_home.PNG");
		Pattern spin=new Pattern("Images/Brownie_Hot/spin.PNG");       
		Pattern url=new Pattern("Images/Brownie_Hot/url.PNG");
		Pattern maximize=new Pattern("Images/Brownie_Hot/maximize.PNG");
		Pattern minimize=new Pattern("Images/Brownie_Hot/minimize.PNG");
		Pattern gamble=new Pattern("Images/Brownie_Hot/gamble.PNG"); 

		Pattern disable_info=new Pattern("Images/Brownie_Hot/disable_info.PNG");
		Pattern disable_lines=new Pattern("Images/Brownie_Hot/disable_lines.PNG");
		Pattern disable_turbo=new Pattern("Images/Brownie_Hot/disable_turbo.PNG");
		Pattern disable_betvalue_click=new Pattern("Images/Brownie_Hot/disable_betvalue_click.PNG");
		Pattern bet=new Pattern("Images/Brownie_Hot/disable_bet.PNG");
		Pattern disable_autoplay=new Pattern("Images/Brownie_Hot/disable_autoplay.PNG");
		...
		Pattern spin_stop=new Pattern("Images/Brownie_Hot/spin_stop.PNG");
		Pattern disable_maxbet=new Pattern("Images/Brownie_Hot/disable_maxbet.PNG");
		Pattern maxbet4=new Pattern("Images/Brownie_Hot/maxbet4.PNG");
		Pattern balance_hide=new Pattern("Images/Brownie_Hot/balance_hide.PNG");
		Pattern hide=new Pattern("Images/Brownie_Hot/hide.PNG");
		Pattern take=new Pattern("Images/Brownie_Hot/take.PNG");
		...
		//Comparing the Bet value after clicking on disbled Bet value button and it should be 0.3
		...
		String ht11 = finder11.find(balance_hide);
		double score11=20;                
	...
	public void bet_value_Credit_value_buttons_should_not_be_clickable_under_spin_condition_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Home, Info and Turbo buttons should not be clickable on screen under spin condition in Brownie Hot slot game$")
	public void home_Info_and_Turbo_buttons_should_not_be_clickable_on_screen_under_spin_condition_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should be disabled during reel spin in Brownie Hot slot game$")
	public void spin_button_should_be_disabled_during_reel_spin_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Spin button should be visible after reel spin stops and if  win is triggered clicking on collect button in Brownie Hot slot game$")
	public void spin_button_should_be_visible_after_reel_spin_stops_and_if_win_is_triggered_clicking_on_collect_button_in_Brownie_Hot_slot_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Gamble button behaviour under win triggered and disabled when next spin starts in Brownie Hot slot game$")
	public void gamble_button_behaviour_under_win_triggered_and_disabled_when_next_spin_starts_in_Brownie_Hot_slot_game() throws Throwable {
		driver.quit();
	}
}
