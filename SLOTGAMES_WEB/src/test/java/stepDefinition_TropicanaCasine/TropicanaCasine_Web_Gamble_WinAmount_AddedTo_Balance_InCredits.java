...
public class TropicanaCasine_Web_Gamble_WinAmount_AddedTo_Balance_InCredits {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_credit_balance_spin_button_credit_win_amount_gamble_button_gamble_amount_in_credits_red_button_black_button_and_gamble_status() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_in_credits_after_win() throws Throwable {
		...
		Pattern win_credits_1 = new Pattern("Images/Tropicana_Casine/win_credits_1.PNG");
		Pattern balance=new Pattern("Images/Tropicana_Casine/balance.PNG");
		Pattern balance_credits_1=new Pattern("Images/Tropicana_Casine/balance_credits_1.PNG");
		Pattern credit_deductbal=new Pattern("Images/Tropicana_Casine/balance_crdeduct_1.PNG");
		...
		Pattern Crpre_gambleamount=new Pattern("Images/Tropicana_Casine/Crpre_gambleamount.PNG");
		Pattern Crpost_gambleamount=new Pattern("Images/Tropicana_Casine/Crpost_gambleamount.PNG");
		Pattern Crpre_gambletowin=new Pattern("Images/Tropicana_Casine/Crpre_gambletowin.PNG");
		Pattern Crpost_gambletowin=new Pattern("Images/Tropicana_Casine/Crpost_gambletowin.PNG");
		Pattern Crpre_suittowin=new Pattern("Images/Tropicana_Casine/Crpre_suittowin.PNG");
		Pattern Crpost_suittowin=new Pattern("Images/Tropicana_Casine/Crpost_suittowin.PNG");
		Pattern credit_gamble_winbalance=new Pattern("Images/Tropicana_Casine/credit_gamble_winbalance.PNG");
		Pattern credit_gamble_winfield=new Pattern("Images/Tropicana_Casine/credit_gamble_winfield.PNG");
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Win amount comparision completed successfully. Win amount is 160");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		//Verify the suit to win amount field
		//Verify the suit to amount field doesn't contain "SRD" and decimal values
		Finder finder37 =new Finder(screen.capture().getImage());
		String ht37 = finder37.find(Crpre_suittowin);
		double score37=20;                
		...
		if(finder37.hasNext())
		{
			...
			System.out.println("pre suit to Win amount");
			finder37.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Pre suit to win comparision: "+" "+score37 +"%");
		Assert.assertTrue(score37 > 96);			  
		Thread.sleep(3000);
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 160 and gamble amount is 160 after 1st win gamble amount is "320"
			...
			//Gamble to win amount post win 
			Finder finder38 =new Finder(screen.capture().getImage());
			String ht38 = finder38.find(Crpost_gambletowin);
			double score38=20;                
			...
			if(finder38.hasNext())
			{
				...
				System.out.println("post gamble to win amount");
				finder38.destroy();  
			}         
			else    
			{ 
			...
			System.out.println("post gamble amount comparision: "+" "+score38 +"%");
			Assert.assertTrue(score38 > 96);			  
			Thread.sleep(3000);

			// suit to win amount post win 
			Finder finder48 =new Finder(screen.capture().getImage());
			String ht48 = finder48.find(Crpost_suittowin);
			double score48=20;                
			System.out.println("the value of ht38"+" "+ht48);
			if(finder48.hasNext())
			{
				Match m48=finder48.next();
				System.out.println("Match Found with: "+(m48.getScore())*100+"%");
				score48=(m48.getScore())*100;
				System.out.println("post suit to win amount");
				finder48.destroy();  
			}         
			else    
			{ 
			...
			System.out.println("post gamble amount comparision: "+" "+score48 +"%");
			Assert.assertTrue(score48 > 96);			  
			Thread.sleep(3000);
		...
		else
		{
			...
			if(finder11.hasNext())
			{
				...
				System.out.println("Balance After losing in gamble. Balance is 29,980");
				finder11.destroy();  
			}         
			else    
			{ 
	...
	public void verify_the_credit_form_of_currency_in_gamble_page_on_all_fields_in_Tropicana_Casine_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
	...
	public void gamble_credit_Win_amount_should_get_added_to_main_balance_after_status_displayed_as_WIN_and_gamble_page_should_get_closed_in_Tropicana_Casine_slot_game() throws Throwable {
		Thread.sleep(1000);
		driver.quit();
	}
}
