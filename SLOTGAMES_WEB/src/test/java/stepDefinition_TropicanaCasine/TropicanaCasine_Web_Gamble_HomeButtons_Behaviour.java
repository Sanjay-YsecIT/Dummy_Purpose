...
public class TropicanaCasine_Web_Gamble_HomeButtons_Behaviour {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_spin_gamble_link_gamble_page_HUD_buttons() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Tropicana_Casine_slot_game_spin_the_reels_and_access_to_gamble_and_click_on_HUD_buttons_present_on_the_screen() throws Throwable {
		...
		Pattern disable_credit=new Pattern("Images/Tropicana_Casine/disable_credit.PNG");
		Pattern disable_betvalue=new Pattern("Images/Tropicana_Casine/disable_betvalue.PNG");
		...
		Pattern disable_hidden=new Pattern("Images/Tropicana_Casine/disable_hidden.PNG");
		Pattern Afterspin_bal=new Pattern("Images/Tropicana_Casine/balance1_1.PNG");
		...
		System.out.println("spinstop is not present & comparision value equals to: "+" "+score17 +"%");
		...
		String ht19 = finder19.find(maxbet4);
		double score19=20;                
		...
		System.out.println("spinstop is not present & comparision value equals to: "+" "+score19 +"%");
		Assert.assertFalse(score19 > 97);
		...
		String ht13 = finder19.find(maxbet4);
		double score13=20;                
		...
		System.out.println("spinstop is not present & comparision value equals to: "+" "+score13 +"%");
		...
		String ht11 = finder19.find(Afterspin_bal);
		double score11=20;                
