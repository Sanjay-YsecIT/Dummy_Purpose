...
public class TropicanaCasine_Web_Gamble_SuitWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_balance_spin_button_win_amount_gamble_button_card_to_click_for_suit_win_and_suit_win_amount() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_click_on_suit_win_card_in_gamble_page() throws Throwable {
		...
		Pattern heart=new Pattern("Images/Tropicana_Casine/heart.PNG");
		Pattern win=new Pattern("Images/Tropicana_Casine/win.PNG");
		Pattern lose=new Pattern("Images/Tropicana_Casine/lose.PNG");
		Pattern balance_suit_win=new Pattern("Images/Tropicana_Casine/balance_suit_win.PNG");
		Pattern balance_suit_lose=new Pattern("Images/Tropicana_Casine/balance1_1.PNG");
		Pattern suit_win=new Pattern("Images/Tropicana_Casine/suit_win.PNG");

		Pattern pre_gambleamount=new Pattern("Images/Tropicana_Casine/pre_suitwin.PNG");
		Pattern post_suitamount=new Pattern("Images/Tropicana_Casine/post_suitamount.PNG");
		...
		if  (screen.exists(win) != null)
		{
			...
			// win amount 1.60 and suit to win amount is 6.40
			//after 1st win gamble amount is "25.60 SRD"
	...
	@Then("^Suit Win amount\\((\\d+)x\\) should get added to the main balance after win else it should not get added to main balance in the Tropicana Casine slot game$")
	public void suit_Win_amount_x_should_get_added_to_the_main_balance_after_win_else_it_should_not_get_added_to_main_balance_in_the_Tropicana_Casine_slot_game(int arg1) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
