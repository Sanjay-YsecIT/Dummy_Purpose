...
public class TropicanaCasine_Web_InfoPage_Navigation {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_balance_info_icon_navigation_icon_exit_icon_payout_paylines_wild_scatter_wheelspin_freespin_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("Images/Tropicana_Casine/forward.PNG");
		Pattern backward=new Pattern("Images/Tropicana_Casine/backward.PNG");
		Pattern exit=new Pattern("Images/Tropicana_Casine/exit.PNG");
		Pattern payout=new Pattern("Images/Tropicana_Casine/payout.PNG");
		Pattern paylines=new Pattern("Images/Tropicana_Casine/paylines.PNG");
		Pattern wild=new Pattern("Images/Tropicana_Casine/wild.PNG");
		Pattern scatter=new Pattern("Images/Tropicana_Casine/scatter.PNG");
		Pattern wheelspin=new Pattern("Images/Tropicana_Casine/wheelspin.PNG");
		Pattern gamble=new Pattern("Images/Tropicana_Casine/infogamble.PNG");
		Pattern jackpot=new Pattern("Images/Tropicana_Casine/jackpot.PNG");
		Pattern gamewindow=new Pattern("Images/Tropicana_Casine/TropicanaCasine.PNG");
		...
		String ht5 = finder5.find(wheelspin);
		double score5=20;                
		...
		String ht61 = finder61.find(wheelspin);
		double score61=20;                
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Tropicana_Casine_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
