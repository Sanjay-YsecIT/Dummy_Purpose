...
public class TropicanaCasine_Web_TransferAmount_Verify {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_balance_text_field_to_transfer_balance_and_Ok_button() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_button() throws Throwable {
		...
		Pattern Beforetransfer=new Pattern("Images/Tropicana_Casine/t_beforetransfer.PNG");
		Pattern Aftertransfer=new Pattern("Images/Tropicana_Casine/balance.PNG");
	...
	public void the_exact_amount_entered_in_the_transfer_page_should_transfer_to_Tropicana_Casine_slot_game_and_same_amount_should_get_displayed_on_the_balance_section() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
