...
public class TropicanaCasine_Web_MaxBet_Option {
	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, Tropicana Casine slot game, max bet option, balance and spin button$")
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_max_bet_option_balance_and_spin_button() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_maxbet_click_on_spin_button_and_check_the_balance() throws Throwable {
	...
	public void balance_should_get_deducted_by_max_credit_and_betvalue_combinationas_per_the_game_specification_in_Tropicana_Casine_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
