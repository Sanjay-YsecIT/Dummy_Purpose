...
public class TropicanaCasine_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value1 {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropicana_Casine_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits() throws Throwable {
	...
	public void open_the_Tropicana_Casine_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Tropicana_Casine_slot_game_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern bet1_1=new Pattern("Images/Tropicana_Casine/bet1_1.PNG");
		Pattern spin=new Pattern("Images/Tropicana_Casine/spin.PNG");
		Pattern win_1 = new Pattern("Images/Tropicana_Casine/win_1.PNG");
		Pattern win_11 = new Pattern("Images/Tropicana_Casine/win_11.PNG");
		Pattern balance1_1=new Pattern("Images/Tropicana_Casine/balance1_1.PNG");

		// credit values
		Pattern credit1_CR = new Pattern("Images/Tropicana_Casine/credit1_CR.PNG");
	...
	public void win_amount_in_credit_multiplied_by_denomination_is_equal_to_win_amount_in_currency_in_Tropicana_Casine_slot_game() throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
