...
public class FortyGlowingHot_Web_Check_MaximizeAndMinimize_Buttons {

	WebDriver driver;
	Screen screen=new Screen();

	@Given("^Chrome browser, valid URL, valid login details, FortyGlowing Hot slot game, maximize button and minimize button$")
	public void chrome_browser_valid_URL_valid_login_details_FortyGlowing_Hot_slot_game_maximize_button_and_minimize_button() throws Throwable {
	...
	public void open_the_FortyGlowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_maximize_button_and_click_on_minimize_button() throws Throwable {
		...
		Pattern url=new Pattern("./Images/40Glowing_Hot/url.PNG");
		Pattern settings=new Pattern("./Images/40Glowing_Hot/settings_icon.PNG");
		Pattern min=new Pattern("./Images/40Glowing_Hot/minimize_icon.PNG");
		Pattern max=new Pattern("./Images/40Glowing_Hot/maximize_icon.PNG");
	...
	public void full_screen_should_be_displayed_after_clicking_on_maximize_button_and_minimized_screen_should_be_displayed_after_clicking_on_minimize_button_in_FortyGlowing_Hot_slot_game() throws Throwable {
