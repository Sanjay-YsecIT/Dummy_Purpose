...
public class FortyGlowingHot_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_FortyGlowing_Hot_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_scatter_dollar_scatter_star_wild_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_FortyGlowing_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/40Glowing_Hot/fwd_navigation.PNG");
		Pattern backward=new Pattern("./Images/40Glowing_Hot/bckwrd_navigation.PNG");
		Pattern exit=new Pattern("./Images/40Glowing_Hot/exit.PNG");
		Pattern payout=new Pattern("./Images/40Glowing_Hot/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/40Glowing_Hot/paylines_info.PNG");
		Pattern scatter_dollar=new Pattern("./Images/40Glowing_Hot/scatterdollar_info.PNG");
		Pattern scatter_star=new Pattern("./Images/40Glowing_Hot/scatterstar_info.PNG");
		Pattern wild=new Pattern("./Images/40Glowing_Hot/wild_info.PNG");
		Pattern gamble=new Pattern("./Images/40Glowing_Hot/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/40Glowing_Hot/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/40Glowing_Hot/game_window.PNG");
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_FortyGlowing_Hot_slot_game() throws Throwable {
