...
public class EmeraldDice_Web_Check_MaximizeAndMinimize_Buttons {
	...
	public void open_the_Emerald_Dice_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_maximize_button_and_click_on_minimize_button() throws Throwable {
		...
		Pattern url=new Pattern("./Images/Emerald_Dice/url.PNG");
		Pattern settings=new Pattern("./Images/Emerald_Dice/settings_icon.PNG");
		Pattern min=new Pattern("./Images/Emerald_Dice/minimize_icon.PNG");
		Pattern max=new Pattern("./Images/Emerald_Dice/maximize_icon.PNG");
...
//				 Thread.sleep(3000);
	...
	public void full_screen_should_be_displayed_after_clicking_on_maximize_button_and_minimized_screen_should_be_displayed_after_clicking_on_minimize_button_in_Emerald_Dice_slot_game() throws Throwable {
