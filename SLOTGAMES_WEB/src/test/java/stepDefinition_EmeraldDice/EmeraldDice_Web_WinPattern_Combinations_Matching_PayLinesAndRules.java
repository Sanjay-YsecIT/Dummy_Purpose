...
public class EmeraldDice_Web_WinPattern_Combinations_Matching_PayLinesAndRules {
	...
	public void chrome_browser_valid_URL_valid_login_details_Emerald_Dice_slot_game_bet_type_denomination_balance_available_symbols_spin_button_win_pattern_combinations_and_line_Combinations_win_amount() throws Throwable {
	...
	public void open_the_Emerald_Dice_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_reels_win_appears_on_the_screen_and_respective_win_combination_lines_with_win_amount_appear_on_the_goodluck_frame() throws Throwable {
		...
		Pattern bell=new Pattern("./Images/Emerald_Dice/3R_bell.PNG");
		Pattern dollar=new Pattern("./Images/Emerald_Dice/2R_dlr.PNG");
		Pattern grape=new Pattern("./Images/Emerald_Dice/3R_grp.PNG");

		// Arranging the win pattern symbols		
		screen.click(seven);
		Thread.sleep(1000);
		screen.click(bell);
		Thread.sleep(1000);
	...
	public void win_pattern_should_highlight_on_the_symbols_and_according_to_win_patterns_line_combinations_with_win_amount_should_display_for_each_pattern_wins_on_the_goodluck_frame_of_Emerald_Dice_slot_game() throws Throwable {
