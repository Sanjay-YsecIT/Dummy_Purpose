...
public class SapphireHeart_Web_Balance_Credits_Calculations_1 {
	...
	public void open_the_Sapphire_Heart_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern creditValue=new Pattern("./Images/Sapphire_Heart/credit_0.01.PNG");
		Pattern Credit_bal=new Pattern("./Images/Sapphire_Heart/cr_bal_30000.PNG");
	...
	@Then("^Balance amount should be same as denomination (\\d+)\\.(\\d+) multiplies by credit in Sapphire Heart slot game$")
	public void balance_amount_should_be_same_as_denomination_multiplies_by_credit_in_Sapphire_Heart_slot_game(int arg1, int arg2) throws Throwable {
