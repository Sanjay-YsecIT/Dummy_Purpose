...
public class SapphireHeart_Web_AutoSpin_AutoSpinOption {
	...
	public void chrome_browser_valid_URL_valid_login_details_Sapphire_Heart_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Sapphire_Heart_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_the_player_instruction_message() throws Throwable {
		...
		Pattern autospin=new Pattern("./Images/Sapphire_Heart/autospin.PNG");
		Pattern credit1=new Pattern("./Images/Sapphire_Heart/goodluck.PNG");
		Pattern pat=new Pattern("./Images/Sapphire_Heart/goodluck.PNG");
	...
	public void system_should_keep_performing_the_spins_in_Sapphire_Heart_slot_game() throws Throwable {
	  
		Pattern autospin_cancel=new Pattern("./Images/Sapphire_Heart/autospin.PNG");
