...
public class SapphireHeart_Web_Check_BetType_BetValue_DropDown3 {
	...
	public void open_the_Sapphire_Heart_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_from_down_and_check_the_bet_value_should_be(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
		...
		Pattern bet_val=new Pattern("./Images/Sapphire_Heart/betvalues_0.06.PNG");
		...
		if(finder.hasNext())
		{
			...
			System.out.println("Credit value comparision happened successfully and value is 0.06. Test case passed");
			finder.destroy();  
		}         
		else    
		{ 
		...
		if(finder1.hasNext())
		{
			...
			System.out.println("Comparision happened successfully. Available denominations are: 6, 12, 18, 24, 30. Test case passed");
			finder1.destroy();  
		}         
		else    
		{ 
	...
	@Then("^Bet value should get changed to (\\d+),(\\d+),(\\d+),(\\d+),(\\d+) if the bet type selected as (\\d+)\\.(\\d+) from the drop down three in Sapphire Heart slot game$")
	public void bet_value_should_get_changed_to_if_the_bet_type_selected_as_from_the_drop_down_three_in_Sapphire_Heart_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
