...
public class SapphireHeart_Web_TransferAmount_Verify {
	...
	public void open_the_Sapphire_Heart_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_button() throws Throwable {
		...
		Pattern Beforetransfer=new Pattern("./Images/Sapphire_Heart/beforetransfer_300.PNG");
		Pattern Aftertransfer=new Pattern("./Images/Sapphire_Heart/aftertransfer_300.PNG");
