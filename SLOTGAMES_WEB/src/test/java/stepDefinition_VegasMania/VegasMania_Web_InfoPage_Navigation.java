...
public class VegasMania_Web_InfoPage_Navigation {
	...
	public void chrome_browser_valid_URL_valid_login_details_Vegas_Mania_slot_game_balance_settings_info_icon_navigation_icon_exit_icon_payout_paylines_seven_feature_wild_gamble_and_jackpot_window() throws Throwable {
	...
	public void open_the_Vegas_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_settings_and_info_icon_and_validate_the_forward_and_backward_button() throws Throwable {
		...
		Pattern forward=new Pattern("./Images/Vegas_Mania/forward.PNG");
		Pattern backward=new Pattern("./Images/Vegas_Mania/backward.PNG");
		Pattern exit=new Pattern("./Images/Vegas_Mania/exit.PNG");
		Pattern payout=new Pattern("./Images/Vegas_Mania/PO_info.PNG");
		Pattern paylines=new Pattern("./Images/Vegas_Mania/paylines_info.PNG");
		Pattern wild=new Pattern("./Images/Vegas_Mania/wild_info.PNG");
		Pattern golden_feature=new Pattern("./Images/Vegas_Mania/golden_seven_feature.PNG");
		Pattern gamble=new Pattern("./Images/Vegas_Mania/gamble_info.PNG");
		Pattern jackpot=new Pattern("./Images/Vegas_Mania/jackpot_info.PNG");
		Pattern game_window=new Pattern("./Images/Vegas_Mania/game_window.PNG");
		...
		//	click on forward icon available on the info page to move to golden seven feature window
		screen.click(forward);
		Thread.sleep(1000);

		Finder finder2 =new Finder(screen.capture().getImage());
		String ht2 = finder2.find(golden_feature);
		double score2=20;                
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("info page is at the golden seven feature window");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		//	click on backward icon available on the info page to move to golden seven feature window
		screen.click(backward);
		Thread.sleep(1000);

		Finder finder8 =new Finder(screen.capture().getImage());
		String ht8 = finder8.find(golden_feature);
		double score8=20;                
		...
		if(finder8.hasNext())
		{
			...
			System.out.println("info page is at golden seven feature window");
			finder8.destroy();  
		}         
		else    
		{ 
	...
	public void forward_backward_and_exit_button_of_info_page_should_perform_in_Vegas_Mania_slot_game() throws Throwable {
