...
public class VegasMania_Web_TryNow_Spin_Deduct_Balance {
	...
	public void chrome_browser_valid_URL_valid_login_details_Vegas_Mania_slot_game_try_now_button_balance_to_play_and_spin_button() throws Throwable {
	...
	public void open_the_Vegas_Mania_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {

		Pattern Trynow_bal=new Pattern("./Images/Vegas_Mania/Try_now_bal.PNG");
		Pattern BalAfterSpin=new Pattern("./Images/Vegas_Mania/TN_BalAfterspin.PNG");
		Pattern Spin=new Pattern("./Images/Vegas_Mania/TN_spin.PNG");
		...
		if(finder1.hasNext())
		{
			...
			System.out.println("Balance should be 4999.90 in try now screen and comparision successfull");
			finder1.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Balance should be 4999.90 in try now screen and comparision value equals to: "+" "+score1 +"%");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Vegas_Mania_slot_game() throws Throwable {
