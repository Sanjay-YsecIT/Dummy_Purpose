...
public class VegasMania_Web_Gamble_GambleCount_For_BetType_4_And_Denomination_3 {

	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Vegas Mania slot game, transfer button, bet type as (\\d+)\\.(\\d+), denomination as TWENTY FIVE, balance, spin button, win amount, gamble button, gamble amount, game info page and gamble count in gamble page of slot game$")
	public void chrome_browser_valid_URL_valid_login_details_Vegas_Mania_slot_game_transfer_button_bet_type_as_denomination_as_TWENTY_FIVE_balance_spin_button_win_amount_gamble_button_gamble_amount_game_info_page_and_gamble_count_in_gamble_page_of_slot_game(int arg1, int arg2) throws Throwable {
	    
		this.driver = VegasMania_URL_Login.getDriver();	
	}

	@When("^Open the Vegas Mania slot game by entering the valid URL in browser, enter the valid login details, click on Vegas Mania slot game, select bet type as (\\d+)\\.(\\d+) & denomination as TWENTY FIVE, click on spin button till player wins, click on gamble button and check the gamble count in gamble page of slot game$")
	public void open_the_Vegas_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Vegas_Mania_slot_game_select_bet_type_as_denomination_as_TWENTY_FIVE_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page_of_slot_game(int arg1, int arg2) throws Throwable {
		...
		Pattern SPIN=new Pattern("./Images/Vegas_Mania/spin.PNG");                         // SPIN BUTTON
		Pattern GAMBLE_COLLECT=new Pattern("./Images/Vegas_Mania/gb_collect.PNG");  // AMOUNT COLLECT ICON ON GAMBLE WINDOW          
		Pattern GAMBLE_BTN=new Pattern("./Images/Vegas_Mania/gb_button.PNG");     // GAMBLE BUTTON TO SWITCH TO GAMBLE WINDOW
		Pattern winBF=new Pattern("./Images/Vegas_Mania/gb_disable.PNG");         // GAMBLE DISABLE BUTTON 
		Pattern betval=new Pattern("./Images/Vegas_Mania/betval4_3.PNG");
		Pattern credit_inc = new Pattern("./Images/Vegas_Mania/credit_inc.PNG");



		// IMAGES IN 1st REELS
		Pattern watermelon1=new Pattern("./Images/Vegas_Mania/1R_watermelon.PNG");
		Pattern lemon1=new Pattern("./Images/Vegas_Mania/1R_lemon.PNG");
		Pattern orange1=new Pattern("./Images/Vegas_Mania/1R_orange.PNG");
		Pattern lemon11=new Pattern("./Images/Vegas_Mania/1R_lemon1.PNG");
		Pattern watermelon11=new Pattern("./Images/Vegas_Mania/1R_watermelon1.PNG");


		// IMAGES IN 2nd REELS
		//	Pattern watermelon2=new Pattern("./Images/Vegas_Mania/2R_watermelon.PNG");
		Pattern bar2=new Pattern("./Images/Vegas_Mania/2R_bar.PNG");
		Pattern lemon2=new Pattern("./Images/Vegas_Mania/2R_lemon.PNG");
		Pattern cherry2=new Pattern("./Images/Vegas_Mania/2R_cherry.PNG");

		// IMAGES IN 5th REELS
		Pattern cherry5=new Pattern("./Images/Vegas_Mania/5R_cherry.PNG");
		Pattern bar5=new Pattern("./Images/Vegas_Mania/5R_bar.PNG");

		Pattern WIN_AMT1=new Pattern("./Images/Vegas_Mania/win_50.PNG");    // 1st WIN AMOUNT WITH GAMBLE ATTEMPTS 5
		Pattern WIN_AMT2=new Pattern("./Images/Vegas_Mania/win_100.PNG");    // 2st WIN AMOUNT WITH GAMBLE ATTEMPTS 4
		Pattern WIN_AMT3=new Pattern("./Images/Vegas_Mania/win_150.PNG");    // 3st WIN AMOUNT WITH GAMBLE ATTEMPTS 3
		Pattern WIN_AMT4=new Pattern("./Images/Vegas_Mania/win_350.PNG");    // 4st WIN AMOUNT WITH GAMBLE ATTEMPTS 2
		Pattern WIN_AMT5=new Pattern("./Images/Vegas_Mania/win_750.PNG");    // 5st WIN AMOUNT WITH GAMBLE ATTEMPTS 1
		Pattern WIN_AMT6=new Pattern("./Images/Vegas_Mania/win_1000.PNG");    // 6st WIN AMOUNT WITH GAMBLE ATTEMPTS 0


		// ATTEMPTS LEFT
		Pattern Attempt_5=new Pattern("./Images/Vegas_Mania/Attempt5.PNG");
		Pattern Attempt_4=new Pattern("./Images/Vegas_Mania/Attempt4.PNG");
		Pattern Attempt_3=new Pattern("./Images/Vegas_Mania/Attempt3.PNG");
		Pattern Attempt_2=new Pattern("./Images/Vegas_Mania/Attempt2.PNG");
		Pattern Attempt_1=new Pattern("./Images/Vegas_Mania/Attempt1.PNG");


		// SET THE BET TYPE AS 0.5 AND DENOMIANTION AS 25
		...
		if(finder1.hasNext())
		{
			...
			System.out.println("If the win amount is 50, gamble count should be 5.");
			finder1.destroy();  
		}         
		else    
		{ 
		...
		if(finder11.hasNext())
		{
			...
			System.out.println("If the win amount is 100, gamble count should be 4.");
			finder11.destroy();  
		}         
		else    
		{ 
		...
		if(finder12.hasNext())
		{
			...
			System.out.println("If the win amount is 150, gamble count should be 3.");
			finder12.destroy();  
		}         
		else    
		{ 
		...
		if(finder13.hasNext())
		{
			...
			System.out.println("If the win amount is 350, gamble count should be 2.");
			finder13.destroy();  
		}         
		else    
		{ 
		...
		if(finder123.hasNext())
		{
			...
			System.out.println("If the win amount is 750, gamble count should be 1.");
			finder123.destroy();  
		}         
		else    
		{ 
		...
		//Arranging the symbols to generate win amount more than 875 and checking gamble link should be disabled
		...
		if(finder1231.hasNext())
		{
			...
			System.out.println("If the win amount is exceeds 875 YSI, gamble link should be disabled.");
			finder1231.destroy();  
		}         
		else    
		{ 
	...
	@Then("^Gamble count should be displayed  on gamble page based on win amount and gamble max amount configured on the game info page for bet type (\\d+)\\.(\\d+) & denomination TWENTY FIVE in Vegas Mania game$")
	public void gamble_count_should_be_displayed_on_gamble_page_based_on_win_amount_and_gamble_max_amount_configured_on_the_game_info_page_for_bet_type_denomination_TWENTY_FIVE_in_Vegas_Mania_game(int arg1, int arg2) throws Throwable {
