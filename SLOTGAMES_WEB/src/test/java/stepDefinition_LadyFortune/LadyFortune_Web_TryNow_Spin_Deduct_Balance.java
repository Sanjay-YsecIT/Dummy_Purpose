...
public class LadyFortune_Web_TryNow_Spin_Deduct_Balance {
	...
	public void open_the_Lady_Fortune_slot_game_by_entering_the_valid_URL_in_browser_click_on_try_now_button_and_click_on_spin_button() throws Throwable {
		...
		Pattern BalAfterSpin=new Pattern("./Images/Lady_Fortune/TN_BalAfterspin.PNG");
		Pattern Spin=new Pattern("./Images/Lady_Fortune/TN_Spin.PNG");
	...
	public void amount_should_get_deducted_from_balance_on_click_on_spin_button_in_try_now_page_of_Lady_Fortune_slot_game() throws Throwable {
