...
public class LadyFortune_Web_Check_FreeSpin_Features_Triggers {
	...
	public void chrome_browser_valid_URL_valid_login_details_Lady_Fortune_slot_game_bet_type_denomination_balance_scatter_symbols_spin_button_and_free_spin_screen() throws Throwable {
	...
	public void open_the_Lady_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_click_on_spin_button_till_Three_or_more_than_Three_scatter_symbols_appears_on_the_screen_wins_and_Free_Spin_Activates_and_spin_amount_added_to_the_win_amount() throws Throwable {
		...
		// IMAGES IN 1st REEL
		Pattern A1 =new Pattern("./Images/Lady_Fortune/1R_a.PNG");
		Pattern ten1 =new Pattern("/Images/Lady_Fortune/1R_10.PNG");
		Pattern Q1 =new Pattern("./Images/Lady_Fortune/1R_q.PNG");
		Pattern wild1 =new Pattern("./Images/Lady_Fortune/1R_wild.PNG");
		Pattern Coin1 =new Pattern("./Images/Lady_Fortune/1R_coin.PNG");
		Pattern Leaf1 =new Pattern("/Images/Lady_Fortune/1R_leaf.PNG");
		...
		// IMAGES IN 4th REEL
		Pattern ten4 =new Pattern("./Images/Lady_Fortune/4R_ten.PNG");
		...
		Pattern shoe4 =new Pattern("./Images/Lady_Fortune/4R_shoe.PNG");
		Pattern nine4=new Pattern("./Images/Lady_Fortune/4R_nine1.PNG");

		// IMAGES IN 5th REEL
		Pattern nine5 =new Pattern("./Images/Lady_Fortune/5R_nine.PNG");
		Pattern feather5 =new Pattern("./Images/Lady_Fortune/5R_feather.PNG");

		// Congrulation and Win window pop-up and free spin left 
		Pattern Cong_msg =new Pattern("./Images/Lady_Fortune/SC_Congrulation_msg.PNG");
		Pattern FreeSpin0 =new Pattern("./Images/Lady_Fortune/SC_FreeSpin0.PNG");
		Pattern FreeSpin10 =new Pattern("./Images/Lady_Fortune/SC_FreeSpin10.PNG");
		Pattern FreeSpin15 =new Pattern("./Images/Lady_Fortune/SC_FreeSpin15.PNG");
		Pattern win_msg =new Pattern("./Images/Lady_Fortune/SC_win_msg.PNG");
	...
	public void fifteen_Free_Spin_screen_should_appear_when_Three_or_more_than_Three_scatter_symbols_appears_on_the_screen_in_Lady_Fortune_game() throws Throwable {
