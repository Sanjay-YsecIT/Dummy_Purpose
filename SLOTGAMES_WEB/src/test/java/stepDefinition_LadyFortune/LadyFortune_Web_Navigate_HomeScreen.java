...
public class LadyFortune_Web_Navigate_HomeScreen {
	...
	public void open_the_Lady_Fortune_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button() throws Throwable {
		...
		Pattern Home_Screen_Logo=new Pattern("./Images/Lady_Fortune/suribet_logo.PNG");
		Pattern Lady_Fortune=new Pattern("./Images/Lady_Fortune/LC_logo.PNG");
		Pattern home=new Pattern("./Images/Lady_Fortune/home.PNG");

		//Comparing whether Lady_Fortune  game is loaded and home button is visible

		// Pattern credit1=new Pattern("E:/Sikuli Images/others/goldenhot.png");

		Finder finder =new Finder(screen.capture().getImage());
		String ht = finder.find(Lady_Fortune);
		double score=20;                
		...
		if(finder.hasNext())
		{
			...
			System.out.println("Lady Fortune game is loaded and comparision successfull.");
			finder.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Lady Fortune is loaded and comparision value equals to: "+" "+score +"%");
		...
		//After clicking on home button, Lady Fortune game should not be visible
		...
		if(finder2.hasNext())
		{
			...
			System.out.println("Navigate to the home screen & Lady Fortune home page should not be visible and comparision successfull.");
			finder2.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Navigate to the home screen of the Lady Fortune slot games and comparision value is equal to: "+" "+score2 +"%");
