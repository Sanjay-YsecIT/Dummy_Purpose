...
public class LadyFortune_Web_Balance_Deduction_AccordingToBetType2_2 {
	...
	@Then("^Balance should get deducted by ONE if the bet type is selected as (\\d+)\\.(\\d+) in Lady Fortune slot game$")
	public void balance_should_get_deducted_by_ONE_if_the_bet_type_is_selected_as_in_Lady_Fortune_slot_game(int arg1, int arg2) throws Throwable {
