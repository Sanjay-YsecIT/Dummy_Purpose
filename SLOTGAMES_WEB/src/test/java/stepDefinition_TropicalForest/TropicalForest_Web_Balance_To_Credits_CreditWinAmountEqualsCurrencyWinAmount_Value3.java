...
public class TropicalForest_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value3 {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_balance_spin_button_win_amount_in_currency_credits_and_win_amount_in_credits_for_denomination_drop_down_value_three() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_denomination_drop_down_value_three_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern win_3 = new Pattern("Images/Tropical_Forest/win_3.PNG");
		Pattern win_31 = new Pattern("Images/Tropical_Forest/win_31.PNG");
		Pattern balance3_1=new Pattern("Images/Tropical_Forest/balance3_1.PNG");

		// credit values
		Pattern credit3_CR = new Pattern("Images/Tropical_Forest/credit3_CR.PNG");
	...
	public void win_amount_in_credit_multiplied_by_denomination_drop_down_value_three_is_equal_to_win_amount_in_currency_in_Tropical_Forest_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
