...
public class TropicalForest_Web_Gamble_SuitWinAmount_quadrupleThan_WinAmount {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_game_balance_spin_button_win_amount_Suit_win_dice_options_gamble_amount_and_suit_to_win_amount() throws Throwable {
	...
	public void open_the_Tropical_Forest_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Tropical_Forest_slot_game_click_on_spin_button_till_player_wins_click_on_suit_win_dice_button_and_check_the_suit_to_win_amount() throws Throwable {
		...
		Pattern suitwin=new Pattern("/Images/Tropical_Forest/suitwin.PNG");
		Pattern suitoption=new Pattern("/Images/Tropical_Forest/suitoption.PNG");
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Gamble Suit Win amount comparision completed successfully. Gamble Suit Win amount is 2 SRD");
			finder3.destroy();  
		}         
		else    
		{ 
	...
	public void suit_To_Win_amount_should_be_quadruple_than_win_amount_in_the_gamble_page_of_the_Tropical_Forest_game() throws Throwable {
		Thread.sleep(1000);
	}

	@Then("^Verify the suit win options and gamble page color, alignment and text fonts in Tropical Forest slot game$")
	public void verify_the_suit_win_options_and_gamble_page_color_alignment_and_text_fonts_in_Tropical_Forest_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
