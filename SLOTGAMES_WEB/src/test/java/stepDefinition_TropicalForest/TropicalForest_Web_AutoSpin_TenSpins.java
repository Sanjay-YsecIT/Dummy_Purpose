...
public class TropicalForest_Web_AutoSpin_TenSpins {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_balance_spin_button_auto_spin_button_ten_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_ten_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern auto_10=new Pattern("Images/Tropical_Forest/auto_10.PNG");
		Pattern auto_list=new Pattern("Images/Tropical_Forest/auto_list.PNG");

		Pattern pat2=new Pattern("Images/Tropical_Forest/9spins.PNG");
		Pattern pat3=new Pattern("Images/Tropical_Forest/8spins.PNG");
		Pattern pat4=new Pattern("Images/Tropical_Forest/7spins.PNG");
		Pattern pat5=new Pattern("Images/Tropical_Forest/6spins.PNG");
		Pattern pat6=new Pattern("Images/Tropical_Forest/5spins.PNG");
		Pattern pat7=new Pattern("Images/Tropical_Forest/4spins.PNG");
		Pattern pat8=new Pattern("Images/Tropical_Forest/3spins.PNG");
		Pattern pat9=new Pattern("Images/Tropical_Forest/2spins.PNG");
		Pattern pat10=new Pattern("Images/Tropical_Forest/1spins.PNG");
		Pattern pat11=new Pattern("Images/Tropical_Forest/0spins.PNG");
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking ten spins option and should perform (\\d+) spins from (\\d+) to (\\d+) Tropical Forest slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_ten_spins_option_and_should_perform_spins_from_to_Tropical_Forest_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
