...
public class TropicalForest_Web_Balance_Check_WinAmount_AddedToBalance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_game_balance_transfer_button_spin_button_and_win_amount() throws Throwable {
		this.driver = TropicalForest_URL_Login.getDriver();
	}

	@When("^Open the Tropical Forest Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the amount, click on spin button till user win and check the balance after win$")
	public void open_the_Tropical_Forest_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_spin_button_till_user_win_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern take=new Pattern("Images/Tropical_Forest/take.PNG");
		Pattern balance=new Pattern("Images/Tropical_Forest/balance.PNG");
		Pattern win_bal=new Pattern("Images/Tropical_Forest/win_bal.PNG");
		Pattern win_pattern=new Pattern("Images/Tropical_Forest/win_pattern.PNG");
