...
public class TropicalForest_Web_AutoSpin_Validations_GamblePage {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality_after_navigating_from_gamble_page() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_after_navigating_from_gamble_page() throws Throwable {
		...
		Pattern autoplay=new Pattern("Images/Tropical_Forest/autoplay.PNG");
		Pattern auto_stop=new Pattern("Images/Tropical_Forest/auto_stop.PNG");
		Pattern auto_auto=new Pattern("Images/Tropical_Forest/auto_auto.PNG");
		Pattern astop=new Pattern("Images/Tropical_Forest/spin_stop.PNG");
		...
		Pattern bet_inc=new Pattern("Images/Tropical_Forest/bet_inc.PNG");
		Pattern balance=new Pattern("Images/Tropical_Forest/balance.PNG");
		Pattern balance_afterspin=new Pattern("Images/Tropical_Forest/balance_afterspin.PNG");
		Pattern credit3=new Pattern("Images/Tropical_Forest/credit3.PNG");
		Pattern bet3_5=new Pattern("Images/Tropical_Forest/bet3_5.PNG");
		...
		/*Checking the balance after win & navigating from gamble page
		  ...
		  win amount is 25 and it is added to main balance after collecting from gamble page hence new bal is 315
		 * 315 is at main balance and after next spin balance is 305 in main balance field
		 * Hence 305 is taken consideration for win amount added to balance during autospin returning from gamble
		 */
		...
		if(finder3.hasNext())
		{
			...
			System.out.println("Balance after win in auto play is 305 and navigating from gamble page & balance comparision completed successfully.");
			finder3.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Balance is 305 SRD after win in autoplay and navigating from gamble page & comparision value equal to: "+" "+score3 +"%");
		...
		//comparing the bet value should be 20 after decreasing
	...
	public void bet_value_Credit_value_buttons_should_be_clickable_after_navigating_from_gamble_page_when_autospin_is_stopped_in_Tropical_Forest_slot_game() throws Throwable {
		Thread.sleep(1000);
	}
