...
public class TropicalForest_Web_AutoSpin_TabsSwitching_Reload_Option {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_balance_transfer_button_spin_button_multiple_tabs_and_reload_option() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_autospin_and_switch_between_tabs_and_again_reload_the_game() throws Throwable {
		...
		Pattern reload=new Pattern("Images/Tropical_Forest/reload.PNG");
		Pattern newtab=new Pattern("Images/Tropical_Forest/newtab.PNG");
		Pattern gametab=new Pattern("Images/Tropical_Forest/gametab.PNG");
	...
	public void switching_between_tabs_should_be_allowed_and_reloading_the_game_resulting_in_ending_game_session_and_shouldn_t_resume_the_Tropical_Forest_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
