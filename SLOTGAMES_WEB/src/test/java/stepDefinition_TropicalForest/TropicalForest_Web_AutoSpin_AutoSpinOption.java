...
public class TropicalForest_Web_AutoSpin_AutoSpinOption {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_the_player_instruction_message() throws Throwable {
		...
		Pattern goodluck=new Pattern("Images/Tropical_Forest/goodluck.PNG");
	...
	public void system_should_keep_performing_the_spins_in_Tropical_Forest_slot_game() throws Throwable {
		Pattern auto_stop=new Pattern("Images/Tropical_Forest/auto_stop.PNG");
		screen.click(auto_stop);
		Thread.sleep(5000);

		Pattern placebet=new Pattern("Images/Tropical_Forest/placebet.PNG");
		Finder finder1 =new Finder(screen.capture().getImage());
