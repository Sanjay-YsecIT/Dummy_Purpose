...
public class TropicalForest_Web_Gamble_GambleLink_Behavior {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tropical_Forest_slot_game_spin_gamble_link_gamble_page_credit_and_bet_values() throws Throwable {
	...
	public void open_the_Tropical_Forest_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_onTropical_Forest_slot_game_spin_the_reels_and_access_to_gamble_link_and_change_the_bet_and_credit_values() throws Throwable {
		...
		Pattern bet1_2=new Pattern("Images/Tropical_Forest/bet1_2.PNG");
		Pattern spin=new Pattern("Images/Tropical_Forest/spin.PNG");
		Pattern balance=new Pattern("Images/Tropical_Forest/balance.PNG");
		Pattern cr1=new Pattern("Images/Tropical_Forest/cr1.PNG");
		Pattern cr2=new Pattern("Images/Tropical_Forest/cr2.PNG");
		...
		Assert.assertFalse(score4 > 96);
		System.out.println("Gamble link is not present");
	}

	@Then("^Verify the gamble link active and inactive state as changed bet and credit values in Tropical Forest slot game$")
	public void verify_the_gamble_link_active_and_inactive_state_as_changed_bet_and_credit_values_in_Tropical_Forest_slot_game() throws Throwable {
		Thread.sleep(2000);
		driver.quit();
	}
}
